...
Imagina que este documento es lo que le presentas a un cliente en la reunión de "kickoff" (inicio) y en la reunión de "reporting" (resultados). ¿Lo contrataría?`,
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        id: 'ads-2-2b',
        title: 'Retargeting en Meta: audiencias por etapa y frecuencia',
        type: 'reading',
        content: '## Por qué el retargeting rinde más que las campañas frías\n\nUna persona que ya visitó tu sitio, vio tu Reel completo, o abrió el carrito sin comprar, tiene una intención mucho más alta que alguien que nunca escuchó de la marca. El retargeting no compite por atención desde cero: recuerda a alguien que ya mostró interés. El CPA de una audiencia de retargeting bien segmentada suele ser una fracción del CPA de una audiencia fría equivalente.\n\n## Audiencias de retargeting por etapa, no una sola bolsa\n\nEl error más común es crear una sola audiencia de "visitantes del sitio en los últimos 30 días" y mostrarles a todos el mismo anuncio. La versión que rinde: segmentar por qué tan cerca estuvieron de convertir.\n\n**Interacción con contenido (más fría)**: personas que vieron el 50%+ de un video, o interactuaron con el perfil de Instagram — reciben un anuncio que profundiza el mensaje, no una oferta directa todavía.\n\n**Visitantes del sitio (media)**: personas que visitaron páginas clave (precios, servicios) pero no completaron una acción — reciben un caso de éxito o testimonio que resuelve la objeción más común.\n\n**Carrito abandonado / lead no cerrado (más caliente)**: personas que casi convirtieron — reciben la oferta más directa, con urgencia legítima si aplica ("tu cotización expira en 48 horas").\n\n## Frecuencia: el punto donde el mismo anuncio empieza a molestar\n\nMeta reporta la frecuencia (impresiones promedio por persona) de cada conjunto de anuncios. Una frecuencia mayor a 3-4 en una campaña de retargeting suele ser señal de audiencia saturada: la gente ya vio el anuncio varias veces sin actuar, y seguir mostrándoselo no cambia esa decisión — solo genera fatiga o, peor, una reacción negativa hacia la marca.\n\n## Secuenciar el mensaje, no solo repetirlo\n\nEn vez de mostrar el mismo creativo indefinidamente, una secuencia de retargeting cambia el ángulo cada pocos días: primero un caso de éxito, después una objeción resuelta, después la oferta directa. Esto se logra con conjuntos de anuncios separados por antigüedad de la audiencia (día 1-3 ve el creativo A, día 4-7 ve el B) o con la función de secuencia de anuncios que Meta ofrece dentro de Advantage+.',
        tasks: [
          'Diseña 3 audiencias de retargeting para un cliente ficticio: interaccion con contenido, visitantes del sitio, y carrito/lead no cerrado',
          'Escribe un mensaje distinto para cada una de las 3 audiencias, con el nivel de directo que corresponde a su cercania a convertir',
          'Revisa la frecuencia de una campana activa (propia o de ejemplo): si supera 3-4, que harias para resolverlo',
        ],
        tip: 'Una audiencia de retargeting muy chica (menos de 1000 personas) satura su frecuencia en pocos dias — si tu sitio no tiene suficiente trafico para una audiencia de retargeting solida, el presupuesto rinde mas en audiencias frias bien segmentadas que en un retargeting sobre una base minuscula.',
        completed: false,
      },
      {
        id: 'ads-2-2c',
        title: 'Testing estructurado: cómo saber si un resultado es real o ruido',
        type: 'reading',
        content: '## El problema con "prueba dos variantes y ve cuál gana"\n\nComparar dos anuncios con pocos datos y declarar un ganador es la forma más común de tomar decisiones basadas en ruido estadístico, no en una diferencia real. Un anuncio con 3 conversiones de 100 clics y otro con 5 de 100 no necesariamente significa que el segundo es mejor — con muestras chicas, esa diferencia puede deberse al azar.\n\n## La regla práctica de volumen mínimo\n\nAntes de sacar conclusiones de un test, cada variante necesita un volumen mínimo de datos — como referencia práctica, al menos 50 conversiones por variante (no solo clics) antes de comparar tasas de conversión con algo de confianza. Con menos que eso, la diferencia observada puede revertirse por completo al juntar más datos.\n\n## Una variable a la vez, o el resultado no dice nada\n\nCambiar el hook Y la imagen Y el CTA al mismo tiempo entre dos variantes hace imposible saber CUÁL de los tres cambios produjo la diferencia de resultado. Un test bien diseñado cambia una sola variable —el hook, por ejemplo— y mantiene todo lo demás idéntico entre variantes.\n\n## Qué hacer con un test que no muestra diferencia clara\n\nUn resultado sin diferencia significativa entre variantes no es un test fallido — es información real: esa variable en particular no está moviendo el resultado, y vale más probar una hipótesis distinta (un ángulo de mensaje diferente, no solo otro color de botón) que seguir iterando sobre algo que ya se probó que no importa.\n\n## El sesgo de mirar resultados a mitad de camino\n\nRevisar un test todos los días y detenerlo apenas una variante "parece" ganar es otra fuente común de conclusiones equivocadas — las primeras horas o el primer día de una campaña suelen tener variación alta que se estabiliza con más tiempo y más datos. Definir de antemano cuánto va a durar el test (días, no horas) y con qué volumen se va a evaluar, antes de lanzarlo, evita la tentación de cortarlo apenas se ve una tendencia todavía inestable.',
        tasks: [
          'Revisa un test A/B que hayas corrido (o uno ficticio con los numeros de la leccion anterior de este modulo) y evalua si el volumen de datos era suficiente para concluir algo',
          'Diseña un test que cambie UNA sola variable entre dos variantes de anuncio',
          'Define, antes de lanzar un test tuyo, cuantos dias va a correr y con cuantas conversiones minimas por variante se va a evaluar',
        ],
        tip: 'Si notas que revisas un test varias veces al dia y cambias de opinion sobre cual variante gana, es la señal mas clara de que todavia no hay suficiente volumen de datos para decidir nada.',
        completed: false,
      },
          {
        id: 'ads-2-proj-inter',
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        id: 'ads-3-3',
        title: 'Estrategias de puja y presupuesto: CPC manual, tCPA y tROAS',
        type: 'reading',
        content: '## La decisión que más afecta el resultado y menos se entiende\n\nElegir mal la estrategia de puja es la forma más común de desperdiciar presupuesto en Google Ads — no porque las keywords estén mal, sino porque el algoritmo está optimizando para el objetivo equivocado.\n\n## CPC manual: control total, menos datos\n\nVos pojés el monto máximo por clic en cada keyword. Ideal para cuentas nuevas sin historial de conversión — el algoritmo automatizado necesita datos que aún no existen, así que el control manual evita que gaste mal mientras se junta ese historial.\n\n## tCPA (target CPA): automatizado por costo de conversión\n\nDefinís cuánto estás dispuesto a pagar POR CONVERSIÓN (no por clic) y Google ajusta las pujas automáticamente para lograrlo. Requiere mínimo 30 conversiones en los últimos 30 días para funcionar bien — con menos datos, el algoritmo adivina y gasta mal.\n\n## tROAS (target ROAS): automatizado por retorno\n\nParecido a tCPA pero optimiza para retorno sobre inversión publicitaria, no solo cantidad de conversiones. Mejor para e-commerce donde el valor de cada venta varía mucho — vender un producto de $500 no es lo mismo que uno de $20, y tROAS lo tiene en cuenta.\n\n## La regla práctica de transición\n\n\`\`\`\nCuenta nueva (0 conversiones)     → CPC manual\n30+ conversiones en 30 días       → probar tCPA\ne-commerce con valores variables  → tROAS en vez de tCPA\n\`\`\`\n\nCambiar de estrategia resetea el aprendizaje del algoritmo — cada cambio necesita 1-2 semanas de \"período de aprendizaje\" con rendimiento inestable antes de estabilizarse. No cambies de estrategia cada semana esperando resultados inmediatos.',
        tasks: [
          'Para tu cliente ficticio, decide qué estrategia de puja usarías al lanzar la cuenta y cúul sería tu plan de transición a los 30 y 60 días',
          'Calcula el tCPA objetivo: si el cliente vende un servicio de $80 con margen de 40% y quiere ROI positivo, ¿cuál es el CPA máximo que puede pagar?',
          'Explica en dos párrafos, como si el cliente no supiera nada de Google Ads, por qué los resultados van a ser inestables las primeras dos semanas tras cualquier cambio de estrategia',
        ],
        tip: 'El error más caro: activar tCPA en una cuenta nueva sin historial. El algoritmo gasta el presupuesto probando al azar mientras aprende, y sin datos previos ese aprendizaje sale caro. Manual primero, automatizado después.',
        completed: false,
      },
      {
        id: 'ads-3-proj',
        title: 'Proyecto: campaña de Search completa, lista para lanzar',
        type: 'project',
        difficulty: 'intermedio',
        projectBrief: 'Arma una campaña de Google Search completa para un negocio real o ficticio, con todo lo necesario para lanzarla mañana mismo — no un ejercicio teórico.',
        deliverables: [
          '3-4 grupos de anuncios temáticos con 8-15 keywords cada uno, en la concordancia correcta para cada caso',
          'Lista de 15+ keywords negativas a nivel de campaña',
          '2 RSA completos por grupo de anuncios (5 headlines + 2 descriptions cada uno)',
          'Estrategia de puja elegida y justificada según el estado de la cuenta (nueva vs. con historial)',
          'Presupuesto diario propuesto con el cálculo de cuántos clics/conversiones esperás generar',
        ],
        tip: 'Antes de entregar, léele los headlines a alguien que no vio el brief — si no entiende qué vende el anuncio en 3 segundos, no lo va a entender un usuario scrolleando resultados de búsqueda.',
        completed: false,
      },
    ],
    resources: [
  ...
  },
  {
    ...
    lessons: [
      {
        id: 'ads-cap-0',
        title: 'Antes de armar el plan: define el embudo completo',
        type: 'practice',
        tasks: [
          'Escribe qué pasa en cada etapa del embudo para tu cliente: ToFu (awareness), MoFu (consideración), BoFu (conversión) — un objetivo de campaña por etapa, no una sola campaña para todo',
          'Define qué gasto en Meta vs. Google es razonable según la etapa: Meta suele rendir mejor en ToFu/MoFu, Search de Google en BoFu (intención ya existe)',
          'Antes de escribir el plan completo, valida el presupuesto con el cliente en una frase: "con $X/mes esperamos Y resultados en Z meses" — evita construir 2 semanas de plan sobre un presupuesto que el cliente nunca aprobaría',
        ],
        tip: 'El plan de 90 días falla más seguido por mal diagnóstico del embudo que por mala ejecución de las campañas. Si el embudo está mal pensado, no importa qué tan bien armadas estén las campañas.',
        completed: false,
      },
      {
        id: 'ads-capstone-1',
      ...
      },
      {
        ...
        type: 'practice',
        tasks: [
          '¿La distribución de presupuesto entre Meta y Google tiene una justificación escrita, o es una división arbitraria 50/50?',
          '¿Cada concepto de creativo está asignado a una etapa específica del embudo (ToFu/MoFu/BoFu), no genérico para \"todo\"?',
          '¿Los KPIs tienen benchmarks reales del sector, no números inventados?',
          '¿El plan de optimización dice QUÉ decisión tomarías si el CPA sube 30% — no solo que \"lo revisarías\"?',
          '¿Podrías presentarle este plan al cliente sin traducir ningún término técnico en vivo?',
        ],
        tip: 'Un plan de paid media que un cliente no puede aprobar sin que le expliques cada línea no está terminado — la claridad es parte del entregable, no un extra.',
        completed: false,
      },
    ],
    resources: [
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        id: 'email-2-1b',
        title: 'Deliverability técnica: SPF, DKIM y DMARC sin jerga',
        type: 'reading',
        content: '## El problema que ningún copy resuelve\n\nEl módulo anterior mencionó deliverability como métrica varias veces — pero nunca qué la determina técnicamente. Podés escribir la secuencia de bienvenida perfecta y que la mitad termine en spam si el dominio no está autenticado correctamente. Esto no es opcional ni avanzado: es la base sin la cual todo lo demás no importa.\n\n## Los tres registros que autentican tu dominio\n\n**SPF (Sender Policy Framework)**: un registro DNS que lista qué servidores tienen permiso de enviar email en nombre de tu dominio. Sin él, cualquiera podría enviar emails haciéndose pasar por tu dominio, y los proveedores de correo lo saben — un dominio sin SPF es más sospechoso por defecto.\n\n**DKIM (DomainKeys Identified Mail)**: firma criptográficamente cada email que sale, probando que el contenido no fue alterado en tránsito y que de verdad salió de un servidor autorizado. Es lo más parecido a un sello de autenticidad en cada mensaje.\n\n**DMARC (Domain-based Message Authentication)**: le dice a los proveedores de correo qué hacer si un email falla las verificaciones de SPF o DKIM — rechazarlo, ponerlo en cuarentena, o solo reportarlo. Sin DMARC, un dominio puede tener SPF y DKIM configurados y aun así no indicar qué hacer cuando algo no cuadra.\n\n## Configurarlos no es trabajo del email marketer solo\n\nEstos tres registros se configuran en el DNS del dominio —normalmente con acceso al proveedor donde se compró el dominio o donde se gestiona el DNS—, no dentro de la herramienta de email marketing. La mayoría de las plataformas (Brevo, Mailchimp, Klaviyo) generan los valores exactos que hay que agregar y ofrecen una verificación automática de que quedaron bien configurados.\n\n## Señales de que algo está mal, sin abrir el DNS\n\nUn open rate que cae de golpe sin razón aparente, o reportes de clientes reales diciendo "no me llegó tu email" mientras la plataforma dice que se envió, son las señales más comunes de un problema de autenticación o de reputación de dominio. La mayoría de las plataformas de email tienen un panel de "salud del dominio" que vale revisar antes de sospechar del contenido del email.\n\n## La cuarentena silenciosa: por qué un dominio nuevo empieza con desconfianza\n\nUn dominio de envío recién creado no tiene historial — los proveedores de correo lo tratan con cautela hasta que demuestra un patrón de envío consistente y de baja queja ("warm-up"). Enviar un volumen alto de golpe desde un dominio nuevo es una de las formas más rápidas de terminar en spam permanentemente. La práctica estándar: empezar con volúmenes bajos y crecerlos gradualmente en las primeras semanas.',
        tasks: [
          'Revisa si un dominio tuyo o de un cliente tiene SPF, DKIM y DMARC configurados (la mayoria de las plataformas de email tienen un verificador)',
          'Si falta alguno, configuralo con los valores que te da tu plataforma de envio',
          'Explica con tus palabras que hace cada uno de los tres registros, sin usar el nombre del otro para explicarlo',
        ],
        tip: 'Si vas a lanzar campanas para un cliente con un dominio de envio recien creado, avisale desde el dia 1 que el volumen debe crecer gradualmente — un cliente que no entiende el warm-up va a preguntar por que no mandaste toda la lista de una vez, y esa conversacion es mas facil ANTES de que pase, no despues de que el dominio termine en spam.',
        completed: false,
      },
      {
        id: 'email-2-2b',
        title: 'Segmentación por comportamiento: enviar menos, pero mejor',
        type: 'reading',
        content: '## Enviar a toda la lista es la forma más rápida de dañarla\n\nLos flujos de este módulo (bienvenida, carrito, reactivación) ya son una forma de segmentación por comportamiento — pero el principio se extiende a cada envío que hacés, no solo a los flujos automatizados. Mandar la misma newsletter genérica a toda la lista, sin importar qué le interesa a cada segmento, es la causa más común de que el open rate baje mes a mes.\n\n## Segmentar por comportamiento, no solo por datos demográficos\n\nLa segmentación demográfica (edad, ubicación) es la más fácil de configurar pero la que menos predice interés real. La segmentación por comportamiento —qué abrió, qué clickeó, qué compró, qué página visitó— predice mucho mejor qué contenido le interesa a cada persona.\n\n**Por engagement**: separar suscriptores muy activos (abren casi todo) de los tibios (abren a veces) y de los inactivos (no abrieron nada en 60+ días) permite un tono y frecuencia distintos para cada grupo, en vez de tratarlos igual.\n\n**Por interés declarado**: si tu lead magnet tenía 3 opciones distintas, cada suscriptor ya te dijo qué le interesa desde el día 1 — usar esa etiqueta para decidir qué contenido de la newsletter le mandás es segmentación casi gratuita.\n\n**Por etapa del cliente**: un suscriptor que nunca compró necesita contenido educativo; uno que ya compró necesita contenido de uso del producto y upsell — mandarle a un cliente actual el mismo email de "por qué elegirnos" que a un lead frío ignora que esa pregunta ya está resuelta.\n\n## El resultado de segmentar bien: menos emails, más resultado\n\nContraintuitivamente, segmentar bien casi siempre significa mandar MENOS emails a cada persona individual (solo lo relevante para su segmento), no más — y ese es exactamente el motivo por el que el open rate y CTR suben cuando se segmenta en serio: cada email que llega es más probable que le interese a quien lo recibe.',
        tasks: [
          'Define 3 segmentos de comportamiento para una lista tuya o ficticia: por engagement, por interes declarado, y por etapa del cliente',
          'Escribe que contenido recibiria cada uno de los 3 segmentos en el proximo envio, y por que es distinto para cada uno',
          'Revisa una lista real: que porcentaje esta en cada nivel de engagement (muy activo, tibio, inactivo)?',
        ],
        tip: 'Si nunca segmentaste una lista, empeza por engagement — es la segmentacion mas simple de implementar en cualquier plataforma y la que mas rapido mejora las metricas generales, antes de invertir tiempo en segmentaciones mas finas.',
        completed: false,
      },
          {
  ...
  },
  {
    ...
    lessons: [
      {
        id: 'email-cap-0',
        title: 'Antes de escribir: define el mapa del ciclo de vida',
        type: 'practice',
        tasks: [
          'Dibuja el ciclo de vida del suscriptor para tu negocio: qué recibe el día 0 (bienvenida), qué recibe si no compra en 7 días, qué recibe si compra (onboarding), qué recibe si deja de abrir emails (reactivación)',
          'Elige UN lead magnet específico antes de escribir ningún email — sin eso, la secuencia de bienvenida no tiene de qué hablar',
          'Decide la herramienta (Brevo, Mailchimp, u otra) antes de escribir, no después — cada una tiene límites distintos de automatización que afectan qué flujos son viables',
        ],
        tip: 'La secuencia de bienvenida más común que falla es la que se escribe antes de decidir el lead magnet. Cada uno de los 5 emails debe conectar con LO QUE la persona pidió al suscribirse, no con contenido genérico de la marca.',
        completed: false,
      },
      {
        id: 'email-capstone-1',
      ...
      },
      {
        ...
        type: 'practice',
        tasks: [
          '¿Cada email de la secuencia de bienvenida tiene un asunto específico y distinto, o son variaciones genéricas del mismo?',
          '¿Probaste el flujo de suscripción vos mismo, de punta a punta, como lo haría un suscriptor real?',
          '¿El calendario de 3 meses tiene variedad de objetivos (educar, vender, fidelizar), o todos los emails venden?',
          '¿Los flujos están activos de verdad en la herramienta, no solo documentados en un Doc?',
          '¿Definiste qué pasa si alguien no abre ningún email en 60 días (flujo de reactivación o limpieza de lista)?',
        ],
        tip: 'Una lista que nunca se limpia termina dañando la reputación del dominio — los proveedores de email penalizan el envío a direcciones inactivas. La higiene de la lista es parte del sistema, no un detalle técnico aparte.',
        completed: false,
      },
    ],
    resources: [],
  ...
  },
  {
    ...
    lessons: [
      {
        id: 'community-cap-0',
        title: 'Antes del calendario: define voz y objetivo por plataforma',
        type: 'practice',
        tasks: [
          'Elige las plataformas para este cliente y justifica cada una — "estar en todas" no es una estrategia, es falta de una',
          'Escribe el tono de voz en 5 adjetivos concretos + 2 ejemplos de frases que la marca SÍ diría y 2 que NUNCA diría',
          'Define el objetivo principal de cada plataforma elegida (awareness, comunidad, ventas directas) antes de planear un solo post — el objetivo decide el formato, no al revés',
        ],
        tip: 'Un calendario editorial sin un objetivo claro por plataforma produce contenido disperso que no construye nada acumulativo. Define el objetivo primero, el calendario es la consecuencia.',
        completed: false,
      },
      {
      ...
      },
      {
        ...
        type: 'practice',
        tasks: [
          '¿El calendario tiene variedad real de formatos, o son 4 semanas del mismo tipo de post?',
          '¿Las 8 piezas de contenido respetan el tono de voz definido, o se nota que las escribiste sin revisarlo?',
          '¿El protocolo de crisis tiene una respuesta REDACTADA lista para copiar y pegar, no solo "responder con calma"?',
          '¿Publicaste de verdad al menos 4 piezas para tener métricas reales, o el proyecto quedó solo en documento?',
          '¿El template de reporte muestra las métricas que le importan al cliente (resultados de negocio), no solo vanity metrics (likes, followers)?',
        ],
        tip: 'Un reporte lleno de likes y followers sin conexión a resultados de negocio es el motivo número uno por el que los clientes cancelan contratos de community management. Conecta siempre las métricas de redes con el objetivo real del cliente.',
        completed: false,
      },
    ],
    resources: [],
