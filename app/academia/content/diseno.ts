...
export const MODULES_DISENO: Module[] = [
  {
    ...
    description:
      'Entiende la diferencia entre UX e UI, aprende los principios visuales que rigen todo diseño digital y completa el primer módulo del Google UX Design Certificate.',
    ...
    lessons: [
      {
        ...
        type: 'reading',
        content:
          '## Dos disciplinas, un mismo objetivo\n\n**UX (User Experience)** es cómo se *siente* usar un producto. ¿El usuario logra su objetivo sin frustrarse? ¿El flujo tiene sentido? ¿La información aparece en el momento correcto? UX es arquitectura invisible.\n\n**UI (User Interface)** es cómo se *ve* ese producto. Los colores, la tipografía, el espaciado, los componentes visuales, la jerarquía. UI es la superficie que el usuario toca.\n\nUn producto puede tener UI hermosa y UX pésima (Instagram en sus primeros años tenía onboarding confuso). Puede tener UX excelente con UI básica (Craigslist sigue siendo usable a pesar de su diseño). El top 1% tiene ambos.\n\n## Por qué un diseñador moderno trabaja los dos\n\nLas empresas ya no contratan un "UX researcher" separado de un "UI designer" a menos que sean muy grandes. En el mercado actual — especialmente en LATAM y para startups — el rol es **Product Designer**: alguien que puede investigar al usuario, definir el flujo y diseñar la interfaz. Eso es lo que construye este track.\n\n## La pregunta filtro\n\nAntes de diseñar cualquier pantalla, hazte estas dos preguntas:\n- **UX**: ¿qué está intentando hacer el usuario en este momento?\n- **UI**: ¿qué elemento visual necesita ver primero para lograrlo?\n\nLa respuesta al UX define qué pones. La respuesta al UI define cómo lo pones.',
        tasks: [
          'Lee el artículo de Nielsen Norman Group "UX vs UI" (hay link en los recursos del módulo)',
          'Abre la app que más usas en el día y anota: 1 decisión de UX acertada, 1 decisión de UI acertada, 1 cosa que cambiarías',
          'En un párrafo, describe cuál es el problema de UX más importante que existe en el sitio de AlphaDev Studios hoy',
          'Busca 3 ofertas de trabajo de "Product Designer" en LinkedIn y anota qué habilidades piden en común',
        ],
        tip: 'La confusión entre UX y UI persiste porque la mayoría de los diseñadores solo hace UI (lo visible) sin pensar en UX (lo funcional). Si entiendes la diferencia desde el día uno y la aplicas, ya tienes una ventaja real sobre el 80% de los diseñadores que aprenden solo las herramientas.',
        completed: false,
      },
      {
        id: 'u1-l1b',
        title: 'Mini-práctica: auditoría UX rápida de 3 apps que usas',
        type: 'practice',
        content:
          '## El objetivo\n\nDesarrollar el ojo crítico de diseño con práctica deliberada. No "esto se ve bien/mal" sino "esto funciona/no funciona porque..." con un principio específico.\n\n## El proceso (30 minutos)\n\nElige 3 apps habituales — una de productividad, una de consumo (Spotify, Netflix) y una de servicio (banco, delivery).\n\nPara cada app, haz este análisis en 10 minutos:\n\n**UX (funcionalidad):**\n- ¿El flujo principal tiene más de 4 pasos? ¿Se podría simplificar?\n- ¿Hay alguna pantalla donde no sabes qué hacer o qué pasó?\n- ¿El feedback de acciones es claro? (¿sabes cuándo algo se guardó o envió?)\n\n**UI (visual):**\n- ¿Hay jerarquía visual clara? ¿El ojo sabe dónde ir primero?\n- ¿El contraste es suficiente para leer cómodamente?\n- ¿Los botones principales son fáciles de encontrar?\n\n**Balance:**\n- ¿Qué tiene mejor esta app: UX o UI? ¿O las dos?\n- Si solo pudieras mejorar UNA cosa, ¿qué sería?',
        tasks: [
          'Elige 3 apps de categorías distintas — incluye una que no te convenza del todo',
          'Para cada app, responde las 7 preguntas por escrito — no solo en la cabeza',
          'Toma screenshots de las pantallas que analizas para tener evidencia visual',
          'Guarda el análisis en Notion — es el inicio de tu repositorio de referencias de diseño',
        ],
        tip: 'Las mejores apps para analizar son las que usas sin pensar — Spotify, WhatsApp, Instagram. Cuando algo funciona tan bien que es invisible, es diseño excelente. Pregúntate: ¿por qué no tengo que pensar cuando lo uso? La respuesta es el aprendizaje.',
        completed: false,
      },
      {
        id: 'u1-l2',
        ...
        type: 'reading',
        content:
          '## Los 4 principios que explican el 80% del diseño\n\nAntes de aprender herramientas, estos principios son el marco mental que te permite mirar cualquier diseño y entender por qué funciona o por qué no.\n\n**Jerarquía visual**: los elementos más importantes son los más grandes, más pesados o más contrastados. El ojo del usuario recorre la pantalla en el orden que tú defines con la jerarquía. Si todo tiene el mismo peso visual, nada es importante.\n\n**Contraste**: la diferencia entre elementos crea énfasis. Contraste de tamaño (headline enorme vs. body pequeño), de color (dorado sobre crema), de peso tipográfico (bold vs. regular). Sin contraste, hay ruido visual.\n\n**Alineación**: los elementos alineados se perciben como organizados y confiables. Una sola línea de alineación guía el ojo. Elementos desalineados generan incomodidad visual aunque el usuario no pueda identificar por qué.\n\n**Proximidad**: los elementos cercanos se perciben como relacionados. Un label y su input van juntos. Un título y su párrafo van juntos. Separar cosas relacionadas — o juntar cosas no relacionadas — rompe la comprensión del usuario.\n\n## Por qué importan antes que Figma\n\nFigma es una herramienta. Los principios son el razonamiento detrás de las decisiones que tomas con esa herramienta. Un diseñador que conoce los principios puede crear un diseño decente en cualquier herramienta. Uno que solo conoce la herramienta crea lo mismo en todas.',
        tasks: [
          'Abre Figma (o papel y lápiz) y rediseña un elemento simple — un botón, una card, un formulario — aplicando los 4 principios conscientemente',
          'Busca 3 capturas de pantalla de apps que uses y anota cómo aplica cada principio (o cómo lo viola)',
          'Toma la home de alphadev.studio y analiza: ¿la jerarquía visual es clara? ¿Qué es lo primero que ve el usuario?',
          'Crea un frame en Figma con el texto "Diseño antes y después" — versión sin principios vs. versión con principios aplicados',
        ],
        tip: 'El principio más ignorado es la proximidad. Muchos diseñadores ajustan colores y tipografías durante horas pero dejan labels flotando lejos de sus inputs o títulos separados de su contenido. Revisa siempre el espaciado entre elementos relacionados — es el ajuste más rápido que más impacto tiene.',
        completed: false,
      },
      {
        id: 'u1-l2b',
        title: 'Mini-práctica: identifica principios visuales en diseños reales',
        type: 'practice',
        content:
          '## El ejercicio\n\nVer los 4 principios aplicados en diseños reales — poder señalar exactamente dónde está cada uno — es lo que convierte la teoría en criterio de diseño.\n\n## Parte 1 — Búsqueda (15 minutos)\n\nBusca en Google Images "SaaS landing page 2025" o "mobile app UI 2025". Elige 3 capturas de diseños que te parezcan de calidad.\n\n## Parte 2 — Análisis (15 minutos)\n\nPara cada diseño, anota:\n\n- **Jerarquía**: ¿cuál es el elemento más importante? ¿El ojo lo ve primero? ¿Por qué?\n- **Contraste**: ¿qué pares de elementos contrastan más? ¿Tamaño, color o peso tipográfico?\n- **Alineación**: dibuja mentalmente las líneas de alineación — ¿cuántas líneas guían el diseño?\n- **Proximidad**: ¿qué elementos están agrupados? ¿El agrupamiento refleja la relación de contenido?\n\n## Parte 3 — Aplicación (10 minutos)\n\nElige uno de los 4 principios y piensa cómo aplicarlo a una sección del sitio de AlphaDev Studios. ¿Hay algo con poco contraste? ¿Algo desalineado? ¿Labels flotando lejos de sus inputs?',
        tasks: [
          'Busca 3 capturas de pantalla de diseños UI que te parezcan de calidad',
          'Analiza cada diseño identificando dónde aparece cada uno de los 4 principios',
          'Anota al menos 1 violación de principio en alguno de los 3 diseños elegidos',
          'Identifica 1 elemento del sitio de AlphaDev Studios donde aplicar un principio mejoraría el diseño',
        ],
        tip: 'Al principio buscas aplicaciones perfectas de los principios. Con el tiempo, el ojo aprende a ver violaciones — y eso es más valioso. Saber exactamente por qué algo se siente incómodo visualmente te convierte en el diseñador que puede articular cambios específicos, no solo decir "algo no me convence".',
        completed: false,
      },
      {
        id: 'u1-l3',
      ...
      },
      {
        ...
        type: 'practice',
        content:
          '## Qué es una auditoría UX\n\nUna auditoría UX es un análisis estructurado de una interfaz existente para identificar problemas de usabilidad, jerarquía visual y flujo de usuario. Es la práctica más directa para desarrollar el "ojo crítico" que distingue a los buenos diseñadores.\n\nA diferencia de opinar ("esto se ve mal"), una auditoría conecta cada observación con un principio o ley: "el botón principal tiene poco contraste con el fondo → viola la Ley de Von Restorff → probablemente tenga menos clicks de los esperados."\n\n## El proceso de una auditoría de una pantalla\n\n**Paso 1 — Elige la pantalla**: login, onboarding, checkout, home, o cualquier pantalla de una app que uses frecuentemente. Evita elegir pantallas demasiado simples — que tenga al menos 5–8 elementos.\n\n**Paso 2 — Mapea la jerarquía visual**: ¿qué elemento ves primero? ¿Segundo? ¿Sigue un orden lógico para el objetivo del usuario?\n\n**Paso 3 — Evalúa cada principio**: revisa jerarquía, contraste, alineación y proximidad. ¿Cuáles se aplican bien? ¿Cuáles se violan?\n\n**Paso 4 — Aplica las leyes de UX**: ¿hay demasiadas opciones (Ley de Hick)? ¿El CTA destaca suficiente (Von Restorff)? ¿El flujo es predecible (Ley de Jakob)?\n\n**Paso 5 — Propuestas de mejora**: por cada problema encontrado, describe qué cambiarías y por qué.',
        tasks: [
          'Elige una pantalla de una app conocida (login, onboarding, checkout) para auditar',
          'Toma screenshot de la pantalla y analiza la jerarquía visual — anota el orden en que tu ojo recorre los elementos',
          'Identifica al menos 3 problemas concretos con referencia al principio o ley que violan',
          'Propón una mejora específica para cada problema identificado',
          'Guarda el análisis completo en Notion o un doc — es el primer ítem de tu proceso como diseñador',
        ],
      ...
      },
      {
        ...
        type: 'practice',
        content:
          '## El brief\n\nElige una app mobile con un flujo de onboarding confuso o poco efectivo y rediséñalo por completo en 4 pantallas. El onboarding es el primer contacto del usuario con el producto — si falla, el usuario abandona antes de descubrir el valor real. Este redesign demuestra pensamiento de producto, no solo habilidad visual.\n\n## Las 4 pantallas a diseñar\n\n1. **Bienvenida / Splash**: primera impresión de la app, comunica el valor en una frase\n2. **Propuesta de valor**: 3 beneficios clave en slides o scroll (con ilustración o screenshot del producto)\n3. **Registro / Cuenta**: formulario de creación — mínima fricción, máxima claridad\n4. **Personalización inicial**: una pregunta que adapta la experiencia al usuario\n\n## El proceso paso a paso\n\n**Paso 1 — Elige la app y documenta el problema**\nCompleta el onboarding real de la app elegida. Anota en qué momento te confundiste, qué pasos son innecesarios y qué información falta. Busca las reseñas en App Store — las quejas de onboarding aparecen en los 1 y 2 estrellas.\n\n**Paso 2 — Screenshots del before + anotaciones**\nImporta las capturas a Figma en una página "Before". Marca con texto y flechas los problemas de UX específicos de cada pantalla.\n\n**Paso 3 — Benchmarking**\nBusca 3 apps del mismo espacio con onboardings efectivos. En Mobbin.com puedes filtrar por "Onboarding" y categoría.\n\n**Paso 4 — Wireframes de las 4 pantallas**\nDibuja la estructura antes de pensar en colores. Decisión clave: ¿slides con puntos de navegación o scroll vertical?\n\n**Paso 5 — UI final**\nDiseña las 4 pantallas en Figma a 390×844px (iOS) o 360×800px (Android).\n\n**Paso 6 — Caso de estudio en Figma**\nUna página con: Before / Problemas detectados / Decisiones de diseño / After.',
        tasks: [
          'Completa el onboarding real de la app elegida y anota cada punto de fricción antes de abrir Figma',
          'Busca en las reseñas de App Store — identifica al menos 3 quejas de onboarding para validar el problema',
          'Haz el benchmarking de 3 apps con buen onboarding en Mobbin.com',
          'Wireframea las 4 pantallas antes de pasar a alta fidelidad',
          'Diseña las 4 pantallas en UI final con el sistema visual de la app',
          'Publica el caso Before/After en Behance con las anotaciones de problemas y decisiones',
        ],
      ...
      },
      {
        ...
        type: 'practice',
        content:
          '## El brief\n\nDiseña una landing page de alta conversión para un producto SaaS. La página debe comunicar el valor del producto en los primeros 5 segundos y guiar al usuario hacia un único CTA: registro gratuito, demo, o contacto.\n\n## Las 6 secciones a diseñar\n\n1. **Hero**: headline de máximo 8 palabras (¿qué hago y para quién?), subheadline, CTA visible sin scroll, screenshot del producto\n2. **Social proof**: logos de empresas que lo usan, o métricas clave ("2,000+ equipos", "4.9/5 en G2")\n3. **Propuesta de valor — 3 columnas**: icono + título + descripción de 2 líneas\n4. **Cómo funciona**: 3–4 pasos con número, título y descripción\n5. **Testimonios**: 2–3 cards con foto, nombre, empresa, texto (máximo 3 líneas)\n6. **CTA final + Footer**: repite la oferta, formulario simple (solo email) o botón directo\n\n## Principios de conversión a aplicar\n\n- Una landing, un objetivo: el header NO tiene links que lleven a otras páginas\n- El CTA primario se repite: en el hero, al final de cada sección y en el footer\n- El headline específico convierte mejor: "Gestión de proyectos para equipos de desarrollo" > "La plataforma todo en uno"\n- La imagen del producto muestra el producto real, no un mockup abstracto\n\n## El proceso\n\n1. Escribe el copy ANTES de abrir Figma — el headline es la decisión más importante\n2. Arma el wireframe de 6 secciones en FigJam\n3. Define tipografía y paleta (para SaaS: sans-serif en todo, 1 color de acento fuerte)\n4. Diseña sección por sección, de arriba hacia abajo\n5. Revisa la jerarquía visual: ¿el ojo va al CTA después del hero?',
        tasks: [
          'Escribe el headline y el copy de cada sección ANTES de diseñar — el diseño sirve al texto',
          'Arma el wireframe de 6 secciones en FigJam antes de pasar a color',
          'Elige tipografía y paleta y crea los styles en Figma antes de diseñar',
          'Diseña la landing en frame de 1440px con contenido a max-width de 1200px',
          'Revisa que el CTA principal aparezca al menos 3 veces (hero + mitad + final)',
          'Publica en Behance con el proceso: copy → wireframe → diseño final',
        ],
        tip: 'El test más rápido para saber si tu landing convierte: muéstrasela a alguien que no conoce el producto durante 5 segundos y preguntale qué hace. Si no puede responderlo, el headline falló. No importa cuán bonita se vea — si el mensaje no es claro en 5 segundos, el visitante se va.',
        completed: false,
      },
          {
        ...
        type: 'project',
        difficulty: 'básico',
        projectBrief: 'Elige un elemento de UI que consideres mal diseñado en cualquier app o sitio web. Analízalo y rediséñalo en Figma.',
        deliverables: [
  ...
  },
  {
    ...
    description:
      'Domina Figma desde interfaz básica hasta componentes, Auto Layout y handoff. Más FigJam para workshops, brainstorming y mapas de flujo colaborativos.',
    ...
    lessons: [
      {
        ...
        type: 'reading',
        content:
          '## El entorno de trabajo de Figma\n\nFigma corre en el browser y en app de escritorio. Crea una cuenta en figma.com — el plan gratuito permite hasta 3 proyectos y es más que suficiente para aprender.\n\nAntes de diseñar cualquier cosa, necesitas entender cómo está organizado el espacio de trabajo:\n\n- **Canvas**: el área infinita donde diseñas. Todo existe aquí.\n- **Panel izquierdo**: capas y páginas del archivo. Aquí organizas los elementos.\n- **Panel derecho**: propiedades del elemento seleccionado — tamaño, color, tipografía, efectos.\n- **Toolbar superior**: herramientas de selección, frame, forma, texto, etc.\n\n## Frames vs Grupos\n\nEsta distinción es crítica y confunde a todos al principio:\n\n**Frame**: el contenedor inteligente de Figma. Tiene un tamaño definido, puede tener constrains, Auto Layout y clip content. Los frames son equivalentes a los `<div>` en HTML. Cada pantalla de una app es un frame.\n\n**Grupo**: un contenedor simple que agrupa elementos sin propiedades propias. Su tamaño cambia automáticamente con el contenido. Usa grupos para agrupar elementos que siempre se mueven juntos.\n\n## Nomenclatura de capas: la disciplina que diferencia\n\nUn archivo de Figma con capas llamadas "Frame 147", "Rectangle 23" y "Group 8" es inútil para trabajar en equipo o para ti mismo en 2 semanas. La convención profesional: `ComponentName/State` o `Screen/Section/Element`. Ej: `Button/Primary`, `Navbar/Desktop`, `Card/Blog/Default`.',
        tasks: [
          'Crea una cuenta en figma.com y completa el tour interactivo oficial de la interfaz',
          'Reproduce desde cero una pantalla simple de una app que uses — sin templates, solo observando y recreando',
          'Renombra todas las capas de tu diseño con una nomenclatura consistente (no "Frame 1", no "Rectangle 3")',
          'Explora el panel derecho: experimenta con fill, stroke, corner radius, effects (sombra, blur)',
        ],
        tip: 'La mayoría de los diseñadores principiantes pasan meses usando Grupos cuando deberían usar Frames. La regla simple: si quieres que el contenedor tenga un tamaño fijo, tenga clip content o vaya a usar Auto Layout → usa Frame. Para todo lo demás → Grupo.',
        completed: false,
      },
      {
        id: 'u2-l1b',
        title: 'Mini-práctica: reproduce una pantalla real en Figma',
        type: 'practice',
        content:
          '## El mejor ejercicio para dominar Figma\n\nReproducir un diseño existente — sin copiar, solo observando — es el equivalente a transcribir una canción en música. Aprendes más en 1 hora de reproducción deliberada que en 5 horas de tutoriales.\n\n## La pantalla a elegir (de menor a mayor complejidad)\n\n- **Opción A**: Una pantalla de login de una app conocida (Apple, Airbnb, Spotify)\n- **Opción B**: La home de una app mobile simple (calculadora, notas, reloj)\n- **Opción C**: Una card de producto de un e-commerce real\n\n## Las reglas del ejercicio\n\n1. Toma screenshot de alta resolución de la pantalla original\n2. Ponla en un frame aparte en Figma como referencia\n3. Crea un nuevo frame del mismo tamaño\n4. Reproduce el diseño SIN mover ni copiar elementos del original\n5. Ponelos uno al lado del otro y compáralos\n6. Anota las 3 diferencias principales que notas\n\n## Lo que vas a descubrir\n\nEspaciados que no se ven a simple vista. Tamaños de texto exactos. La diferencia entre una sombra sutil y ninguna sombra. La construcción interna de las capas.',
        tasks: [
          'Elige la pantalla y toma screenshot de alta resolución',
          'Crea el frame del mismo tamaño en Figma y reproduce el diseño elemento por elemento',
          'Renombra TODAS las capas con nombres descriptivos — cero "Frame 1" o "Rectangle 3"',
          'Ponla junto al original y anota las 3 diferencias principales que notas entre ambas',
        ],
        tip: 'No te frustres si no queda perfecta — eso es parte del ejercicio. Las diferencias entre tu reproducción y el original son exactamente los conceptos que todavía tienes que dominar. "El padding era 16px, no 12px" o "la sombra usa 15% de opacidad, no 40%" son lecciones específicas que los tutoriales nunca cubren con esa precisión.',
        completed: false,
      },
      {
        id: 'u2-l2',
        ...
        type: 'reading',
        content:
          '## Qué es Auto Layout y por qué cambia todo\n\n**Auto Layout** es el sistema de layout de Figma equivalente a **flexbox en CSS**. Cuando aplicas Auto Layout a un frame, los elementos hijos se organizan automáticamente según las reglas que defines — y el frame se adapta cuando el contenido cambia.\n\nSin Auto Layout: si el texto de un botón crece, tienes que ajustar el botón manualmente. Con Auto Layout: el botón crece solo.\n\n## Los conceptos clave\n\n**Dirección**: Horizontal (elementos en fila) o Vertical (elementos en columna). Equivalente a `flex-direction: row` o `column`.\n\n**Spacing**: el espacio entre elementos hijos. Equivalente a `gap` en CSS.\n\n**Padding**: el espacio entre el borde del frame y sus hijos. Igual que `padding` en CSS.\n\n**Hug vs Fixed vs Fill**: cómo se comporta el tamaño del elemento.\n- **Hug**: el frame abraza a sus hijos (se achica y agranda con el contenido)\n- **Fixed**: tamaño fijo que no cambia\n- **Fill**: ocupa todo el espacio disponible del padre\n\n## Por qué es indispensable en diseño profesional\n\nCuando diseñas con Auto Layout desde el principio, tus componentes son responsivos por naturaleza. Un botón diseñado con Auto Layout funciona igual con "Guardar" que con "Guardar cambios del perfil de usuario" — sin ajustes manuales.',
        tasks: [
          'Aplica Auto Layout a un botón: frame horizontal, padding 12px vertical y 24px horizontal, spacing entre ícono y texto',
          'Crea una card de blog con Auto Layout vertical: imagen + título + descripción + CTA — que el alto se adapte al texto',
          'Diseña una navbar horizontal con Auto Layout: logo a la izquierda + links en el centro (Fill) + CTA a la derecha',
          'Experimenta cambiando el texto de los componentes y verifica que el layout se adapta automáticamente',
        ],
        tip: 'La clave para dominar Auto Layout rápido: abre cualquier componente de un UI kit gratuito de Figma Community y desármalo — mira cómo está construido. Los UI kits profesionales usan Auto Layout en todos los componentes. Aprender mirando y desmontando lo que otros construyeron es el atajo más rápido.',
        completed: false,
      },
      {
        id: 'u2-l3',
      ...
      },
      {
        ...
        type: 'practice',
        content:
          '## El componente más enseñado, el más mal construido\n\nUn botón construido correctamente con Auto Layout, variantes y estados bien definidos demuestra más dominio de Figma que 10 pantallas con estilos inconsistentes.\n\n## El objetivo: Button con 4 variantes\n\n**Tipo**: Primary / Secondary\n**Estado**: Default / Disabled\n\nCombinado = 4 variantes.\n\n## Los requisitos técnicos\n\n- **Auto Layout** horizontal: padding 12px vertical, 24px horizontal\n- **Texto**: Inter 600, 14px — color overrideable por variante\n- **Primary**: fondo #9A7235, texto blanco\n- **Secondary**: fondo transparente, borde 1px #9A7235, texto #9A7235\n- **Disabled**: opacity 40% en ambos tipos — sin cambiar el color base\n- **Corner radius**: 6px en todos\n\n## Después de construirlo\n\nUsa 3 instancias del botón en un frame de prueba. Cambia el texto de cada una — verifica que el ancho se adapta automáticamente. Cambia el tipo a Secondary desde el panel de variantes. Eso es un componente bien construido.',
        tasks: [
          'Crea el componente Button desde cero con Auto Layout — sin templates ni UI kits',
          'Configura las 4 variantes: Primary/Secondary × Default/Disabled',
          'Usa 3 instancias en un frame y verifica que el text override funciona en cada una',
          'Cambia el color de fondo del Primary en el maestro — verifica que las 3 instancias se actualizan',
        ],
        tip: 'El estado Disabled se hace mejor con opacity reducida que cambiando el color. Así el Disabled es siempre consistente con el estado Default — y si cambias el color primario del brand, el Disabled sigue siendo correcto automáticamente sin ajustes manuales.',
        completed: false,
      },
      {
        id: 'u2-l4',
      ...
      {
        id: 'u2-l4b',
        title: 'Mini-práctica: prototipa un flujo de 3 pantallas',
        type: 'practice',
        content:
          '## El objetivo: un prototipo funcional en 45 minutos\n\nUn flujo de 3 pantallas con transiciones conectadas. Simple pero completo: el usuario puede navegar de A a B a C y volver, sin que el prototipo se rompa.\n\n## Las opciones de flujo\n\n- **Opción A**: Lista de tareas → Detalle de tarea → Confirmación de completado\n- **Opción B**: Búsqueda → Resultados → Detalle de resultado\n- **Opción C**: Home de una app → Formulario → Pantalla de confirmación\n\n## Los requisitos\n\n- Cada pantalla tiene al menos 1 elemento interactivo (botón, card, link)\n- Conecta los 3 frames con al menos 2 tipos de transición distintos: Navigate To + Open Overlay\n- El usuario puede volver atrás desde cualquier pantalla\n- Al menos 1 transición usa Smart Animate (las capas deben tener el mismo nombre en los dos frames)\n\n## Cómo verificarlo\n\nAbre el modo Present (Ctrl+Enter). Navega el flujo completo sin mirar el editor. Si en algún momento te quedaste atascado — ese es un problema de UX que el prototipo reveló. Anótalo.',
        tasks: [
          'Elige el flujo y diseña las 3 pantallas priorizando la funcionalidad sobre el estilo visual',
          'Conéctalos con Navigate To y configura los triggers correctos en cada botón',
          'Agrega al menos 1 Open Overlay (modal o confirmación) en el flujo',
          'Configura 1 transición con Smart Animate y verifica que los nombres de capa coinciden',
          'Muéstraselo a alguien sin explicarle qué hacer — anota si puede completar el flujo solo',
        ],
        tip: 'La prueba más honesta de un prototipo: dáselo a alguien sin participación en el diseño y observa sin intervenir. Cada vez que dude o presione en el lugar equivocado es un problema de diseño, no de la persona. 5 minutos de observación silenciosa valen más que horas de revisión interna.',
        completed: false,
      },
      {
        id: 'u2-l5',
        ...
        type: 'reading',
        content:
          '## Qué es FigJam y para qué usarlo\n\n**FigJam** es la pizarra colaborativa de Figma — un espacio infinito donde equipos trabajan en tiempo real. No es para diseño visual (eso es Figma Design) sino para pensar, explorar y alinear antes de diseñar.\n\nCasos de uso principales:\n\n- **User flows**: mapear el camino que sigue el usuario desde que abre la app hasta que completa su objetivo\n- **Brainstorming**: generar ideas sin filtro antes de converger en una solución\n- **Workshops remotos**: retrospectivas de equipo, priorización de features, kick-offs de proyecto\n- **Site maps**: la estructura de navegación de un sitio o app antes de diseñar las pantallas\n\n## Los elementos clave de FigJam\n\n**Sticky notes**: el elemento más usado. En FigJam son interactivas — las puedes mover, agrupar por color, votar con stamps.\n\n**Conectores**: flechas que muestran el flujo o la relación entre elementos. En user flows, cada conector es una acción o decisión del usuario.\n\n**Stamps de votación**: en workshops, cada participante vota visualmente las ideas con emojis. Democratiza las decisiones.\n\n**Templates**: FigJam tiene decenas de templates para user flows, retrospectivas, customer journey maps, brainstorming — úsalos como punto de partida.\n\n## El flujo correcto: FigJam ANTES de Figma\n\nSiempre mapea el user flow en FigJam antes de diseñar las pantallas en Figma. Las decisiones que tomas en el flujo (qué pantallas existen, qué acciones llevan a dónde) determinan cuántas pantallas vas a diseñar y por qué.',
        tasks: [
          'Abre FigJam y crea un user flow de la pantalla que auditaste en el módulo anterior — de la home al resultado final',
          'Usa conectores para mostrar cada acción del usuario y sticky notes para anotar decisiones de diseño',
          'Explora al menos 3 templates de FigJam y anota cuándo usarías cada uno',
          'Invita a alguien a colaborar en tu FigJam en tiempo real y co-edita un flujo juntos',
        ],
        tip: 'El user flow en FigJam no necesita ser perfecto desde el principio — tiene que ser entendible. Si alguien que no estuvo en la reunión puede seguir el flujo sin que se lo expliques, está bien. Si necesita explicación para entenderlo, simplifica.',
        completed: false,
      },
      {
        id: 'u2-l6',
        ...
        type: 'practice',
        content:
          '## El entregable completo de este módulo\n\nEsta práctica integra todo lo aprendido en las 5 lecciones anteriores en un proyecto cohesivo: un user flow en FigJam que guía un diseño de 5 pantallas en Figma.\n\n## El proyecto\n\nElige una app simple para diseñar (gestor de tareas, recetario, app de clima, tracker de hábitos — cualquiera que te sea familiar como usuario). La simplicidad es intencional: el objetivo es ejecutar bien los conceptos, no crear un producto complejo.\n\n## Entregable 1 — FigJam: User Flow\n\nAntes de abrir Figma Design, abre FigJam y mapea el flujo completo:\n- ¿Cuántas pantallas hay en el flujo principal?\n- ¿Qué acción lleva de una pantalla a la siguiente?\n- ¿Hay puntos de error o pantallas alternativas?\n- ¿Cuál es el happy path (el flujo ideal sin errores)?\n\n## Entregable 2 — Figma Design: 5 pantallas\n\nUsando el user flow como guía, diseña las 5 pantallas del happy path:\n\n- **Auto Layout** en todos los frames y componentes\n- **Mínimo 5 componentes reutilizables** (botón, input, card, navbar, footer)\n- **Variantes en al menos 1 componente** (botón con estados Default/Disabled como mínimo)\n- **Prototype funcional** que conecte las 5 pantallas siguiendo el user flow\n\n## Criterio de calidad\n\nAntes de dar el proyecto por terminado: ¿podría alguien que no participó en el diseño entender el flujo y navegar el prototipo sin explicación? Si la respuesta es sí, está listo.',
        tasks: [
          'Mapea el user flow completo en FigJam con conectores y sticky notes antes de abrir Figma Design',
          'Diseña las 5 pantallas en Figma usando Auto Layout desde el primer elemento',
          'Crea al menos 5 componentes reutilizables y usa instancias en las pantallas',
          'Conecta todas las pantallas con un prototipo funcional usando las transiciones aprendidas',
          'Prueba el prototipo con alguien externo sin explicarle nada — anota qué no entiende o dónde se pierde',
        ],
        tip: 'Si al diseñar la pantalla 3 te das cuenta de que algo del user flow no tenía sentido, vuelve a FigJam y actualízalo. El flujo y el diseño evolucionan juntos — no son dos etapas separadas que se hacen en secuencia perfecta. La iteración entre FigJam y Figma Design es el proceso real de diseño.',
        completed: false,
      },
      {
        id: 'up-m2',
        ...
        type: 'practice',
        content:
          '## El brief\n\nDiseña desde cero una app de seguimiento de hábitos — uno de los proyectos más pedidos porque combina simplicidad de interfaz con complejidad de comportamiento. El desafío: hacer que registrar un hábito sea tan simple que se convierta en un hábito en sí mismo.\n\n## Las 6 pantallas a diseñar\n\n1. **Home — Vista de hoy**: lista de hábitos del día, estado de completado, racha actual, progreso\n2. **Agregar hábito**: nombre, icono o emoji, frecuencia, hora de recordatorio\n3. **Detalle de hábito**: historial del mes en calendario de puntos, racha, estadísticas\n4. **Estadísticas**: progreso semanal/mensual en gráfico de barras, mejor racha global\n5. **Perfil / Configuración**: nombre, avatar, notificaciones, tema claro/oscuro\n6. **Estado vacío**: pantalla cuando no hay hábitos creados — orientar, motivar, call to action\n\n## El proceso paso a paso\n\n**Fase 1 — Define al usuario y el principio de diseño**\nEl usuario: profesional ocupado (25–35 años) que quiere 2–3 hábitos consistentes. Principio: "una acción, un tap" — registrar un hábito completado debe ser un solo tap en la home.\n\n**Fase 2 — User flow**\nMapea en FigJam: crear hábito → ver en home → marcar completado → ver estadísticas.\n\n**Fase 3 — Sistema visual**\nElige la dirección: minimalista monochrome (como Streaks) o colorido y gamificado (como Habitica). Define la paleta antes de diseñar. Regla: un color por hábito para diferenciación visual rápida.\n\n**Fase 4 — UI final + componentes**\nDiseña la Home primero. Crea el componente "Habit Row" con variantes: completado / pendiente / saltado. Después aplícalo en el resto de pantallas.\n\n**Fase 5 — Prototipo**\nConecta las 6 pantallas con Smart Animate — especialmente el tap de "marcar completado" con feedback visual.',
        tasks: [
          'Define el usuario, el principio de diseño y el sistema visual antes de abrir Figma',
          'Mapea el user flow en FigJam — create habit → home → mark complete → stats',
          'Diseña el componente "Habit Row" con variantes antes de construir la Home',
          'Diseña las 6 pantallas incluyendo el estado vacío con call to action claro',
          'Construye el prototipo con Smart Animate para el gesto de completar hábito',
          'Publica en Dribbble con el componente Habit Row + en Behance con el proceso completo',
        ],
        tip: 'La pantalla de estadísticas es donde muchos diseñadores se pierden en datos innecesarios. El usuario de una app de hábitos no necesita un analytics dashboard — necesita sentirse bien con su progreso. Prioriza el streak y el porcentaje de éxito sobre métricas complejas. La motivación emocional convierte en retención.',
        completed: false,
      },
      {
        id: 'up-m3',
        ...
        type: 'practice',
        content:
          '## El brief\n\nDiseña una app de finanzas personales completa — uno de los espacios más competitivos en UX mobile. El reto: hacer que datos financieros complejos sean claros, accionables y no generen ansiedad. El diseño debe equilibrar densidad de información con claridad visual.\n\n## Las 9 pantallas a diseñar\n\n1. **Dashboard principal**: balance total, gastos del mes vs presupuesto, últimas transacciones, accesos directos\n2. **Lista de transacciones**: filtros por fecha/categoría, búsqueda, ítem con categoría + monto + fecha\n3. **Detalle de transacción**: monto, categoría con icono, comercio, fecha/hora, nota, editar/eliminar\n4. **Agregar transacción**: teclado numérico prominente, categoría con scroll horizontal, cuenta, nota\n5. **Vista de presupuestos**: barra de progreso por categoría, alerta si se superó el límite\n6. **Detalle de presupuesto**: historial del mes, comparación con mes anterior, transacciones de la categoría\n7. **Metas de ahorro**: tarjetas con progreso (ej: "Vacaciones — 65% completado"), contribución sugerida\n8. **Perfil y configuración**: cuentas vinculadas, notificaciones, moneda, privacidad\n9. **Alerta / Notificación**: modal de alerta (ej: "Superaste el 90% de tu presupuesto de comida")\n\n## El proceso paso a paso\n\n**Fase 1 — Arquitectura de la información**\nBusca los onboardings de Fintual, Mint, YNAB para entender qué información priorizan. Define qué ve el usuario primero al abrir la app.\n\n**Fase 2 — Sistema de color semántico**\nEl más importante del proyecto: verde = positivo/ingreso, rojo = alerta/límite superado, gris = transacción normal. NO uses rojo para todos los gastos — los gastos son normales, no errores.\n\n**Fase 3 — Componentes críticos**\nDiseña primero: Transaction Row (el más repetido), Budget Progress Bar (estados: normal/warning/exceeded), Amount Display (con colores semánticos).\n\n**Fase 4 — Pantallas en orden de complejidad**\nComienza por agregar transacción (más funcional), luego lista, luego dashboard. Termina con resumen y configuración.',
        tasks: [
          'Investiga 3 apps de finanzas (Mint, Fintual, YNAB) y mapea sus arquitecturas de información',
          'Define el sistema de color semántico completo antes de diseñar',
          'Diseña los 3 componentes críticos (Transaction Row, Budget Bar, Amount) antes de ensamblar pantallas',
          'Diseña las 9 pantallas comenzando por la más funcional (agregar transacción)',
          'Agrega los estados de error y vacío para la lista de transacciones y el dashboard',
          'Conecta las 9 pantallas en prototipo completo y publica el caso en Behance',
        ],
        tip: 'El diseño de finanzas tiene una trampa: usar rojo para gastos. Los gastos son normales — no son errores. Usar rojo para toda transacción de egreso crea ansiedad innecesaria. Usa rojo solo para alertas (presupuesto superado). El color rojo debe significar "necesitas actuar", no "gastaste dinero".',
        completed: false,
      },
      {
        id: 'up-d2',
        ...
        type: 'practice',
        content:
          '## El brief\n\nDiseña un portfolio personal para ti mismo (o un personaje ficticio) como diseñador o desarrollador. En 10 segundos el visitante debe saber quién eres, qué haces y querer ver tu trabajo. La dirección estética es editorial y tipográfica — menos es más.\n\n## Las 4 páginas a diseñar\n\n1. **Home**: hero con nombre + rol + frase de posicionamiento, grid de proyectos seleccionados (4–6), sección breve de skills, CTA para contacto\n2. **Proyecto — Detalle**: hero del proyecto (screenshot grande), context (cliente/rol/año), el problema, el proceso con imágenes, el resultado final\n3. **About**: foto o ilustración personalizada, bio en 3 párrafos (quién eres / qué haces / qué te diferencia), experiencia, herramientas, qué buscas actualmente\n4. **Contact**: email + formulario simple, links a LinkedIn/GitHub/Dribbble, ubicación\n\n## La dirección de diseño\n\nEditorial minimalista: máximo espacio negativo, 2 fuentes (1 serif para nombre/headlines, 1 sans-serif para cuerpo), paleta de 3 colores (fondo/texto/acento), fotos del trabajo en blanco y negro o con overlay.\n\nReferencias: portafolios de Paco Coursey, Marc Edwards, Luro, o cualquier diseñador que trabaje en Linear, Vercel o Stripe.\n\n## El proceso\n\n1. Elige los 4 proyectos que van al portfolio — la curaduría importa más que la cantidad\n2. Escribe la bio y el posicionamiento antes de abrir Figma\n3. Define el par de fuentes y la paleta de 3 colores como estilos\n4. Diseña la Home — es la que define el tono de todo\n5. Diseña el detalle de proyecto y duplícalo para el resto',
        tasks: [
          'Elige los 4–6 proyectos que van al portfolio — la curaduría define el posicionamiento',
          'Escribe la bio y el texto de posicionamiento antes de abrir Figma',
          'Define el par de fuentes y la paleta de 3 colores como estilos de Figma',
          'Diseña la Home completa en 1440px — es la que define el tono de todo el sitio',
          'Diseña la página de Proyecto Detalle y aplícala a 2 proyectos diferentes',
          'Conecta las 4 páginas en prototipo con navegación completa y publica en Behance',
        ],
        tip: 'El error más dañino en un portfolio es mostrar todo lo que hiciste. Un portfolio de 4 proyectos excelentes convierte mejor que uno de 12 mediocres. Los clientes y empleadores no buscan cantidad — buscan evidencia de que puedes resolver problemas específicos. Cuanto más específico es tu portfolio, más fácil es para el cliente ideal contactarte.',
        completed: false,
      },
          {
  ...
  },
  {
    ...
    description:
      'El puente entre diseño estático y UI memorable. Aprende a crear animaciones con propósito en Figma: timing, easing, before/after states, Smart Animate, y cómo exportar y presentar tus prototipos.',
    duration: '3–4 semanas',
    status: 'available',
    lessons: [
      {
      ...
      },
      {
        ...
        type: 'practice',
        content:
          '## Por qué la base estática importa antes del motion\n\nLa animación sobre un diseño mediocre solo lo hace más notorio. Antes de agregar cualquier movimiento, el diseño estático tiene que sentirse moderno, intencionado y de alta calidad.\n\nTres elementos que diferencian un diseño moderno de uno genérico:\n\n## Grid no convencional\n\nLos diseños amateur colocan todos los elementos en una cuadrícula simétrica y predecible. Los diseños modernos tienen superposición deliberada: el headline invade la zona de la imagen, un elemento flota fuera del grid, hay asimetría controlada. Esto crea tensión visual positiva que hace que el ojo explore la pantalla.\n\n## Layering (profundidad)\n\nElementos que se solapan crean la sensación de que la interfaz tiene capas — profundidad. Una imagen que sobresale del card, un texto que se superpone a una foto, un elemento que "rompe" el contenedor. Cuando después animas con Smart Animate, el layering hace que la animación se vea cinematográfica.\n\n## Tipografía de alto contraste\n\nEl jump de tamaño entre el headline y el body text es lo que más diferencia un diseño premium de uno genérico. Si el headline es 16px y el body es 14px, no hay jerarquía. Si el headline es 64px y el body es 16px, hay impacto.\n\n## La tarea de referencia\n\nBusca 5 heroes de sitios premiados en Awwwards.com. Toma screenshot de cada uno y pégalo en un frame de Figma. Por cada uno, anota: qué hace con el grid, cómo usa el layering, qué contraste tipográfico tiene. Luego reproduce los 5 heroes desde cero.',
        tasks: [
          'Busca 5 heroes en Awwwards.com — elige variedad (dark, light, tipográfico, con imágenes, con 3D)',
          'Pega los screenshots en un frame de Figma y analiza por escrito el grid, layering y contraste tipográfico de cada uno',
          'Reproduce 2 de los 5 heroes desde cero en Figma — sin copiar, solo observar y recrear',
          'Aplica al menos 1 elemento de layering y 1 de tipografía de alto contraste a un diseño tuyo existente',
        ],
        tip: 'Reproducir heroes ajenos es el ejercicio más valioso que existe para mejorar el ojo de diseño. No es plagiar — es el mismo proceso que hace un músico que transcribe canciones de otros para aprender técnica. Lo que aprendes reproduciendo un hero de Awwwards en 2 horas equivale a semanas de teoría.',
        completed: false,
      },
      {
        id: 'u7-l3',
      ...
      },
      {
        ...
        type: 'practice',
        content:
          '## Cómo funciona Smart Animate\n\n**Smart Animate** detecta elementos con el mismo nombre de capa en dos frames conectados y anima automáticamente las diferencias (posición, tamaño, opacidad, rotación, blur). Es el feature más poderoso de Figma para motion.\n\n**Regla crítica**: los nombres de capa en el frame Before y en el frame After deben ser **exactamente idénticos**. Si un layer se llama "Headline" en After y "headline" en Before, Smart Animate no lo empareja.\n\n## El workflow correcto\n\n1. Diseña el **estado After primero** — el estado final en reposo, cómo se ve la UI cuando ya cargó completamente\n2. Duplica el frame → renómbralo "Before"\n3. En el frame Before, modifica las propiedades iniciales de cada elemento:\n   - **Headline** → `y +16–24px` + `opacity 0%`\n   - **Subhead** → `y +8–12px` + `opacity 0%` (con delay mayor)\n   - **CTA** → `scale 0.98` + `opacity 0%` → en After va a `scale 1` + `opacity 100%`\n   - **Imagen/Ilustración** → `scale 0.96` + `blur 8px` → en After: `scale 1` + `blur 0`\n4. En la pestaña Prototype, conecta Before → After con **Smart Animate** + tu easing custom\n\n## Errores comunes a evitar\n\n- Animar más de 4–5 elementos simultáneamente (el ojo no puede seguirlos)\n- Mover elementos más de 40px (se siente exagerado)\n- Usar Linear en el easing (regla de oro del módulo anterior)\n- Olvidar verificar que el orden de lectura se respeta: headline → subhead → CTA',
        tasks: [
          'Abre uno de los tutoriales de AyzZ en los recursos del módulo y replica la animación exacta paso a paso',
          'Aplica el workflow Before → After a un hero que diseñaste: configura los estados iniciales con los valores recomendados',
          'Conecta Before → After con Smart Animate y tu easing custom — reproducilo en Present mode',
          'Verifica que el orden de aparición de los elementos sigue la jerarquía de lectura (headline primero, CTA último)',
          'Haz la misma animación con tu propio diseño — no copies la estructura del tutorial, aplica los principios',
        ],
        tip: 'Diseñar el After primero es contraintuitivo pero crítico. Cuando diseñas el Before primero, tiendes a animar lo que es fácil de mover, no lo que tiene propósito. Cuando empiezas con el After — el diseño ya terminado y funcional — y luego defines desde dónde va a aparecer cada elemento, las decisiones de motion son mucho más deliberadas.',
        completed: false,
      },
      {
        id: 'u7-l5',
        ...
        type: 'reading',
        content:
          '## El problema de animar páginas completas\n\nCuando una página entera tiene animaciones, el riesgo es el caos visual: todo se mueve al mismo tiempo, en la misma dirección, con el mismo timing. El resultado es ruido — nada llama la atención porque todo compite.\n\nLa solución es **ritmo y jerarquía**: las animaciones de una página deben verse coordinadas, no simultáneas.\n\n## La fórmula por sección\n\n**1. Define la jerarquía**: ¿qué elemento de la sección es más importante? Ese aparece primero y solo. Los demás lo siguen.\n\n**2. Aplica stagger**: cuando hay varios elementos que aparecen juntos (por ejemplo, 3 cards en una fila), cada uno tiene un delay de **40–60ms** respecto al anterior. Nunca los tres al mismo tiempo.\n\n**3. Usa un patrón consistente**: si en el hero el texto aparece desde abajo, que en todas las secciones el texto también aparezca desde abajo. La consistencia crea la sensación de intencionalidad. El usuario no lo nota conscientemente, pero siente que el sitio está diseñado.\n\n**4. Limita la concurrencia**: máximo 3 elementos animándose simultáneamente en cualquier momento. El resto espera o está quieto.\n\n## En Figma\n\nCrea un frame "Before" y uno "After" por cada sección. Conéctalos con Smart Animate para simular el comportamiento on-scroll. Cuando vayas a producción, estos estados se implementan con intersection observers en código o con las herramientas de scroll animation de Webflow/Framer.',
        tasks: [
          'Elige una landing page de referencia en Awwwards y analiza el ritmo de sus animaciones de scroll — ¿hay stagger? ¿Patrón consistente?',
          'Diseña 2 secciones distintas de una landing (hero + features) y crea los estados Before/After para cada una',
          'Aplica stagger manualmente: define el delay de cada elemento (elemento 1: 0ms, elemento 2: 50ms, elemento 3: 100ms)',
          'Conecta las secciones en un flujo de prototipo y reproduci el resultado completo en Present mode',
        ],
      ...
      },
      {
        ...
        type: 'practice',
        content:
          '## El loop de publicación del diseñador moderno\n\nDiseñar → animar → grabar → editar → publicar. Este ciclo, repetido semana a semana, construye un portfolio en movimiento que demuestra habilidad en tiempo real. No necesitas proyectos terminados — necesitas prototipos de 10–20 segundos que muestren una interacción específica.\n\n## Setup de grabación\n\n**Herramientas**: Figma en Present mode + grabador de pantalla (OBS Studio en Windows/Linux, QuickTime en Mac, o Outplayed)\n\n**Preparación**: presenta el prototipo al 100% de zoom, cierra apps pesadas, define exactamente qué interacción vas a grabar antes de apretar record.\n\n**Configuración**:\n- Resolución: 1920×1080 (horizontal) o 1080×1920 (vertical para Reels)\n- FPS: **60 obligatorio** — las animaciones grabadas a 30fps pierden suavidad\n- Formato: MP4 H.264\n- Bitrate: 12–20 Mbps\n- Cursor: ocúltalo si la animación es automática\n\n## Edición\n\nImporta el clip en un editor de video (CapCut, DaVinci Resolve, Premiere). Recorta los frames muertos al inicio y al final. Haz crop ajustado para eliminar bordes del browser. Considera hacer el video **loopeable**: que el último frame conecte suave con el primero.\n\n## Export por canal\n\n- **Reels/TikTok**: 1080×1920 vertical, 60fps\n- **Portfolio/YouTube**: 1920×1080, 60fps\n- **Dribbble/Behance**: 1600–1920px de ancho, 60fps',
        tasks: [
          'Graba el prototipo animado que construiste en este módulo — mínimo una interacción de 10 segundos',
          'Edita el clip: recorta frames muertos, ajusta crop, verifica que el video esté suave al 60fps',
          'Exporta en formato horizontal (1920×1080) para portfolio y vertical (1080×1920) para Reels',
          'Publica el clip en al menos una plataforma (Dribbble, Instagram, LinkedIn o TikTok)',
          'Postea de nuevo la semana siguiente con una nueva interacción — establece el ritmo de publicación',
        ],
  ...
  },
  {
    ...
    description:
      'Pasa de diseño a sitio publicado sin escribir código. Webflow para webs complejas con CMS, Framer para landing pages con animaciones avanzadas y conexión directa con Figma.',
    duration: '3–4 semanas',
    status: 'available',
    lessons: [
      {
        ...
        type: 'reading',
        content:
          '## El error de usar siempre la misma herramienta\n\nCada herramienta tiene un caso de uso óptimo. Usar Webflow para todo es tan ineficiente como usar código para todo. El diseñador moderno elige la herramienta correcta según el proyecto.\n\n## El mapa de decisión\n\n**Webflow** → Sitios de marketing con múltiples páginas, blogs con CMS, portfolios con colecciones de proyectos, sitios corporativos que un cliente va a actualizar solo. Requiere aprender su sistema de clases CSS visual — curva de aprendizaje de 1–2 semanas para diseñadores.\n\n**Framer** → Landing pages de alto impacto, portfolios personales, sitios con animaciones complejas y conexión directa con Figma. Genera React internamente. Menor curva de aprendizaje si ya sabes Figma. Menos flexible que Webflow para CMS complejo.\n\n**Código (Next.js)** → Cuando necesitas control total: lógica de negocio, autenticación, base de datos propia, escala real, integraciones de API. Es lo que construye AlphaDev Studios para clientes. La herramienta de máxima flexibilidad con máxima responsabilidad técnica.\n\n## Las preguntas para decidir\n\n- ¿El cliente va a actualizar el contenido solo? → Webflow (CMS visual)\n- ¿Necesitas animaciones premium en poco tiempo? → Framer\n- ¿Hay lógica de negocio, autenticación o BD? → Código\n- ¿Es un sitio estático de presentación? → Framer o Webflow (cualquiera)\n- ¿El presupuesto es muy limitado y necesitas ir rápido? → Framer',
        tasks: [
          'Lista 3 proyectos reales o hipotéticos y decide qué herramienta usarías para cada uno y por qué',
          'Crea una cuenta gratuita en webflow.com y otra en framer.com — explóralas por 30 minutos cada una',
          'Busca 3 sitios hechos en Webflow y 3 en Framer en sus galerías oficiales — ¿puedes notar la diferencia de estilo?',
          'Elige cuál vas a usar para la práctica final de este módulo (Webflow o Framer) y justifica la elección',
        ],
        tip: 'Framer tiene la curva de aprendizaje más corta si ya vienes de Figma — la interfaz es casi idéntica. Si tienes 2 semanas para aprender y publicar algo, empieza con Framer. Webflow tiene más potencia a largo plazo pero necesita más tiempo de inversión inicial para dominarlo correctamente.',
        completed: false,
      },
      {
        id: 'u5-l2',
        ...
        type: 'reading',
        content:
          '## El concepto central de Webflow\n\nWebflow es CSS visual. Cada ajuste que haces en el Style Panel genera CSS real en el background. Si entiendes box model, flexbox y grid, aprender Webflow es mapear esos conceptos a una interfaz visual.\n\nSi no los entiendes todavía, Webflow te va a enseñar CSS aunque no lo parezca.\n\n## La interfaz de Webflow\n\n**Navigator (panel izquierdo)**: el árbol de elementos de la página — equivalente al inspector de Chrome o las capas de Figma. Aquí ves la estructura HTML de tu diseño.\n\n**Style Panel (panel derecho)**: las propiedades CSS del elemento seleccionado — layout (flexbox/grid), spacing (margin/padding), typography, borders, effects.\n\n**Canvas central**: el diseño en tiempo real, responsive y visual.\n\n## Clases: la lógica más importante de Webflow\n\nEn Webflow, los estilos se aplican mediante **clases CSS** (como en código). Un elemento puede tener una clase base + clases modificadoras. Esta lógica es poderosa pero requiere disciplina:\n\n- Nunca estilices el elemento "All H2s" directamente — crea clases específicas\n- Nomenclatura consistente: `Heading-Hero`, `Card-Blog`, `Button-Primary`\n- Evita los estilos inline (el panel los llama "custom") — siempre usa clases\n\n## El punto de partida obligatorio\n\nAntes de tocar cualquier template, completa el **Webflow 101 Crash Course** en Webflow University. Es gratuito, tarda ~2 horas y cubre todo lo que necesitas para entender la lógica de la herramienta.',
        tasks: [
          'Completa el Webflow 101 Crash Course en university.webflow.com (link en recursos del módulo)',
          'Crea un proyecto vacío y construye una navbar simple con Webflow — logo a la izquierda, links en el centro, botón a la derecha',
          'Aplica el sistema de clases correctamente: no uses estilos inline, usa clases con nombres claros',
          'Explora el modo responsive: verifica que tu navbar se vea correctamente en tablet y mobile',
        ],
        tip: 'El error más común al empezar con Webflow es editar el elemento "Heading 2" o "Paragraph" en lugar de crear clases propias. Cuando haces eso, estás cambiando el estilo de TODOS los heading 2 del sitio. Siempre selecciona el elemento y dale un nombre de clase antes de aplicar cualquier estilo.',
        completed: false,
      },
      {
        id: 'u5-l2b',
        title: 'Mini-práctica: construye una navbar en Webflow',
        type: 'practice',
        content:
          '## El primer componente real en Webflow\n\nUna navbar parece simple pero hacerla bien en Webflow requiere entender el sistema de clases, el elemento Navbar nativo y el comportamiento responsive. Es el ejercicio más completo para aprender la lógica de la herramienta en poco tiempo.\n\n## La navbar a construir\n\n**Desktop**: logo a la izquierda + 3–4 links + botón CTA\n**Mobile**: logo + hamburger icon que abre un menú vertical\n\n## El proceso paso a paso\n\n1. Crea un proyecto nuevo en Webflow\n2. Inserta el elemento **Navbar** nativo (no un Div manual — el Navbar maneja el hamburger automáticamente en mobile)\n3. Reemplaza "Brand" por el logo de AlphaDev (imagen o texto con la fuente correcta)\n4. Actualiza los links con nombres y URLs reales\n5. Agrega el botón CTA y estílalo con clases propias\n6. Aplica TODOS los estilos mediante clases — cero estilos custom/inline\n\n## La verificación responsive\n\nCambia al breakpoint Mobile Small en el editor de Webflow. El hamburger debe funcionar y los links mostrarse en vertical sin configuración adicional.',
        tasks: [
          'Inserta el Navbar element y reemplaza el Brand por el logo de AlphaDev',
          'Actualiza los 3–4 links del menú con nombres y URLs reales de AlphaDev Studios',
          'Agrega y estila el botón CTA usando una clase nombrada (ej: "nav-cta")',
          'Verifica en el Style Panel que no hay estilos custom/inline — todo debe estar en clases',
          'Revisa en Mobile Small que el hamburger funciona y los links se apilan correctamente',
        ],
        tip: 'El error más común en Webflow: crear Divs manuales para la navbar en lugar de usar el elemento Navbar nativo. El Navbar nativo ya tiene el comportamiento del hamburger integrado y funciona en mobile sin código adicional. Siempre prefiere los elementos semánticos de Webflow sobre estructuras de Divs manuales.',
        completed: false,
      },
      {
        id: 'u5-l3',
        ...
        tasks: [
          'Crea una colección CMS simple en Webflow: "Proyectos" con los campos título, descripción, imagen y tecnologías',
          'Diseña la página de lista y la página de detalle usando elementos conectados al CMS',
          'Configura al menos 1 Interaction on-scroll: un fade-in-up para las cards de la página de lista',
          'Agrega 3 entradas de ejemplo en el CMS y verifica que el diseño se adapta a cada una',
        ],
        tip: 'El CMS de Webflow es el argumento de venta más fuerte para clientes que necesitan actualizar contenido solos. En lugar de cobrar por "hacer un sitio web", puedes cobrar por "un sistema que el cliente puede mantener sin depender de ti". Eso cambia completamente la propuesta de valor — y el precio que puedes cobrar.',
        completed: false,
      },
      {
        id: 'u5-l4',
        ...
        type: 'reading',
        content:
          '## Por qué Framer es el paso natural después de Figma\n\nSi ya dominas Figma, Framer tiene la curva de aprendizaje más baja de todos los constructores web — su interfaz es casi idéntica: frames, capas, Auto Layout, componentes. La diferencia es que lo que diseñas en Framer se publica como un sitio real.\n\n## Los features clave de Framer\n\n**Import desde Figma**: copias frames de Figma y los pegas en Framer. Funciona bien para estructura y estilos básicos. Las variables y componentes complejos de Figma requieren ajuste manual.\n\n**Breakpoints**: el sistema responsive de Framer es visual — diseñas cómo se ve en Desktop, Tablet y Mobile sin escribir media queries.\n\n**Scroll animations**: parallax, fade-in-up, sticky elements, zoom on scroll — todo configurado visualmente con el panel de animaciones de scroll. Sin código.\n\n**Code overrides**: cuando necesitas lógica personalizada, Framer permite conectar componentes React a cualquier elemento del diseño. El puente entre no-code y código real.\n\n**Publicación**: dominio propio con 1 click. El subdominio de Framer (tusite.framer.app) es gratuito — suficiente para portfolio y pruebas.\n\n## El límite de Framer\n\nFramer no tiene CMS robusto como Webflow. Para sitios con mucho contenido dinámico o e-commerce complejo, Webflow o código son mejores opciones. Framer brilla en landing pages, portfolios y sitios de presentación con animaciones premium.',
        tasks: [
          'Importa un frame de Figma a Framer y verifica qué elementos se trasladan bien y cuáles necesitan ajuste',
          'Configura los breakpoints responsive: ajusta el diseño para que funcione en Desktop (1440px) y Mobile (390px)',
          'Aplica al menos 2 scroll animations: 1 fade-in-up en una sección y 1 efecto parallax en una imagen',
          'Publica el sitio con el subdominio gratuito de Framer y guarda el link',
        ],
        tip: 'Framer es la herramienta más rápida para pasar de "tengo el diseño en Figma" a "tengo un sitio publicado". Para una landing page de presentación, puedes ir de Figma a Framer publicado en 2–3 horas si el diseño está limpio. Esta velocidad es un argumento de venta real para clientes que necesitan algo rápido y con calidad premium.',
        completed: false,
      },
      {
        id: 'u5-l4b',
        title: 'Mini-práctica: publica tu primera landing en Framer',
        type: 'practice',
        content:
          '## De cero a publicado en 2 horas\n\nFramer tiene la relación más directa entre esfuerzo y resultado visible. Esta práctica termina con una URL pública que puedes mostrar hoy.\n\n## El brief: 3 secciones para AlphaDev Studios\n\n**Sección 1 — Hero**: Headline + subheadline + botón CTA + imagen o elemento visual\n**Sección 2 — Features**: 3 beneficios con icono + título + descripción de 2 líneas\n**Sección 3 — CTA final**: Headline de cierre + botón\n\n## El proceso\n\n1. Crea un proyecto nuevo en Framer (o usa un template como base para aprender más rápido)\n2. Diseña cada sección con el layout de Framer (similar a Figma pero con publicación directa)\n3. Agrega al menos 1 scroll animation en la Sección 2 (fade-in-up en los 3 features)\n4. Configura el título de la página y la meta description en Settings > SEO\n5. Publica con el subdominio gratuito (.framer.app) y guarda la URL\n\n## El criterio de completado\n\nAlguien puede visitar la URL, entender de qué trata el negocio en 5 segundos, y hacer click en el CTA sin ayuda.',
        tasks: [
          'Diseña las 3 secciones con contenido real — cero Lorem Ipsum',
          'Configura al menos 1 scroll animation en la sección de features',
          'Configura título de página y meta description antes de publicar',
          'Publica con el subdominio gratuito y guarda la URL',
          'Abre la URL en tu celular y verifica que se ve correctamente en mobile',
        ],
        tip: 'Si la landing no se ve bien en mobile, el problema casi siempre es el mismo: elementos con ancho fijo en px en lugar de Fill o porcentaje. Para que algo ocupe todo el ancho en mobile, el width debe estar en Fill. Revisa todos los contenedores principales si algo se corta o desborda.',
        completed: false,
      },
      {
        id: 'u5-l5',
      ...
      },
      {
        ...
        type: 'practice',
        content:
          '## El brief\n\nDiseña el sitio web de un restaurante o cafetería en desktop (1440px) y mobile (390px). El brief es claro, el contenido es concreto y las restricciones son conocidas. Ideal para demostrar que sabes adaptar diseños entre breakpoints manteniendo la identidad visual.\n\n## Las 4 páginas × 2 breakpoints = 8 pantallas\n\n**Home**\n- Desktop: hero full-screen con foto de ambiente + nombre/tagline/CTA, platos destacados en grid de 3, sobre nosotros (texto + foto), botón al menú\n- Mobile: hero compacto, platos en scroll horizontal (cards), sobre nosotros apilado\n\n**Menú**\n- Desktop: sidebar con categorías fijas + platos en 2 columnas con foto/nombre/descripción/precio\n- Mobile: tabs horizontales de categorías + lista vertical de platos\n\n**Reservas**\n- Desktop: formulario (fecha/hora/personas/nombre/email/notas) en 2 columnas, info del restaurant al lado\n- Mobile: formulario de una columna a pantalla completa\n\n**Contacto**\n- Desktop: mapa embebido grande + datos de contacto en panel lateral + redes sociales\n- Mobile: mapa compacto arriba, datos apilados abajo\n\n## El proceso responsivo\n\n1. Diseña las 4 páginas desktop completas\n2. Define cómo cambia cada sección en mobile: ¿qué se apila? ¿qué desaparece? ¿qué se convierte en scroll horizontal?\n3. Diseña las 4 páginas mobile con Auto Layout para adaptación estructural\n4. Conecta ambas versiones en prototipos separados',
        tasks: [
          'Elige el restaurante y define la identidad visual: paleta, tipografía, estilo de fotografía',
          'Diseña las 4 páginas desktop completas antes de pasar a mobile',
          'Arma un mapa de adaptación responsiva: para cada sección, cómo cambia en mobile',
          'Diseña las 4 páginas mobile usando Auto Layout para adaptación estructural',
          'Crea dos prototipos: desktop (scroll) y mobile (navegación en hamburger menu)',
          'Publica las 8 pantallas en Behance con desktop y mobile lado a lado',
        ],
  ...
  },
  {
    ...
    description:
      'Crea micro-animaciones, transiciones y motion graphics para interfaces digitales. Aprende a exportar animaciones como Lottie para usarlas en Framer, Webflow o cualquier app.',
    duration: '3–4 semanas',
    status: 'available',
    lessons: [
      {
        id: 'u6-l1',
        title: 'After Effects para diseñadores UI: qué necesitas y qué no',
        type: 'reading',
        content:
          '## El estándar de la industria para motion design\n\n**After Effects** es la herramienta de referencia para motion graphics y animación en la industria. No necesitas dominarla completamente — como diseñador UI, el foco está en un subconjunto específico de funcionalidades.\n\n## Qué SÍ necesitas aprender\n\n- **Animaciones de interfaz**: micro-interacciones, loading states, feedback visual, transiciones entre pantallas\n- **Motion graphics para redes**: animaciones de 5–15 segundos para Instagram Reels, TikTok o LinkedIn\n- **Exportación a Lottie**: convertir tus animaciones en JSON para usarlas en web y mobile sin código pesado\n\n## Qué NO necesitas dominar (todavía)\n\n- Compositing de video con footage real\n- VFX y efectos especiales\n- 3D complejo (Cinema 4D, Element 3D)\n- Rotoscoping y tracking de movimiento\n\n## La interfaz de After Effects\n\n**Project Panel** (izquierda): donde importas assets (imágenes, videos, archivos de Figma, audio)\n\n**Composition Panel** (centro): el preview en tiempo real de tu animación\n\n**Timeline** (abajo): el eje temporal donde colocas keyframes y manejas las capas\n\n**Panels de herramientas** (derecha): efectos, controles de capa, herramientas de render\n\n## Cómo acceder\n\nDescarga After Effects desde Adobe Creative Cloud. Tiene un **trial gratuito de 7 días**. Después cuesta ~$55 USD/mes solo o viene incluido en el plan completo de Creative Cloud a ~$60 USD/mes.',
        tasks: [
          'Descarga After Effects e instálalo desde Adobe Creative Cloud (trial gratuito disponible)',
          'Explora la interfaz: identifica el Project Panel, el Composition Panel y el Timeline',
          'Crea tu primera composición: File > New > New Composition, 1080×1080px, 30fps, 5 segundos',
          'Importa un elemento simple (un PNG de Figma) y colócalo en la composición',
        ],
        tip: 'No necesitas comprar Adobe Creative Cloud completo para aprender AE. El trial de 7 días alcanza para hacer las prácticas de este módulo. Cuando termines el trial y quieras seguir, busca el plan "Single App" de After Effects — es más barato que el paquete completo.',
        completed: false,
      },
      {
        id: 'u6-l2',
      ...
      },
      {
        ...
        type: 'reading',
        content:
          '## Qué es Lottie\n\n**Lottie** es un formato de animación basado en JSON desarrollado por Airbnb. Convierte animaciones de After Effects en archivos JSON livianos que se reproducen a 60fps nativamente en web (usando lottie-web), iOS y Android.\n\nUn archivo Lottie de una animación de 3 segundos pesa típicamente 10–50KB — vs un GIF equivalente que puede pesar 500KB–2MB. Esa diferencia de peso es crítica para performance web.\n\n## El flujo de exportación\n\n**Paso 1**: Instala el plugin **Bodymovin** en After Effects\n- Descárgalo como ZXP desde aescripts.com/bodymovin/\n- Instálalo con el ZXP Installer (gratuito)\n- En AE: Window > Extensions > Bodymovin\n\n**Paso 2**: Diseña la animación usando solo elementos compatibles:\n- Shape Layers ✅\n- Solids con efectos básicos ✅\n- Text layers ✅ (con restricciones)\n- Plugins de terceros ❌ (no exportan)\n- Efectos complejos de AE (blur, glow, etc.) ❌ (o exportan mal)\n\n**Paso 3**: Exporta con Bodymovin → genera el archivo `.json`\n\n## Dónde usarlo\n\n- **Framer**: componente Lottie nativo — pegas el JSON directamente\n- **Webflow**: widget de Lottie en el panel de componentes\n- **React**: librería `lottie-react` o `@lottiefiles/react-lottie-player`\n- **HTML puro**: librería `lottie-web` con 3 líneas de JS',
        tasks: [
          'Instala Bodymovin en After Effects y verifica que aparece en Window > Extensions',
          'Exporta el loader circular de la lección anterior como Lottie .json',
          'Verifica la animación en lottiefiles.com (puedes subir el .json y previsualizarlo)',
          'Inserta el .json de Lottie en el proyecto de Framer que publicaste en el módulo anterior',
          'Exporta también el botón con estados y el ícono hamburguesa → X como Lottie',
        ],
        tip: 'Antes de exportar a Lottie, previsualiza la animación en LottieFiles.com para verificar que se ve correctamente. Algunos efectos de AE no se exportan bien — es mejor descubrirlo antes de que el desarrollador te diga que la animación no funciona en producción.',
        completed: false,
      },
      {
        id: 'u6-l5',
        ...
        tasks: [
          'Toma 2 pantallas del prototipo que diseñaste en Figma e impórtalas en AE como PNG',
          'Anima la transición entre ellas: la pantalla 1 sale hacia la izquierda mientras la pantalla 2 entra desde la derecha',
          'Aplica stagger en los elementos de la pantalla 2 (titulos, imágenes, botones aparecen en secuencia)',
          'Exporta la transición como MP4 y evalúa si se siente natural o abrupta',
        ],
      ...
      },
      {
        ...
        type: 'practice',
        content:
          '## El entregable: un asset reutilizable para proyectos reales\n\nEsta práctica produce algo concreto que puedes reusar en cualquier proyecto futuro: un kit de 5 animaciones Lottie listas para producción.\n\nNo es un ejercicio de práctica descartable — es un activo real. Cuando trabajes en un proyecto de Framer, Webflow o Next.js, tendrás estas animaciones disponibles sin necesidad de rehacerlas.\n\n## Las 5 animaciones del kit\n\n**1. Loading spinner**: círculo con Trim Path y rotación infinita. El estándar para cualquier estado de carga.\n\n**2. Checkmark de éxito**: un checkmark que se dibuja solo (Trim Path), con un círculo de fondo que aparece. Para confirmaciones, formularios enviados, pagos completados.\n\n**3. Error shake**: un elemento que sacude horizontalmente — la misma animación que usas cuando una contraseña es incorrecta. Opcional: agregar un ícono de error que aparece.\n\n**4. Card fade + slide up**: una card que entra desde abajo con fade. Es la animación de entrada más usada en listas y grillas. Loop de 1 vez.\n\n**5. Ícono animado**: cualquier ícono de tu elección que tenga un estado animado — like (corazón que pulsa), share, bookmark, etc.\n\n## Entrega\n\nExporta los 5 archivos como `.json` de Lottie. Guarda todos en una carpeta en Google Drive o Notion con el nombre "UI Animation Kit". Agrega el link al kit en tu portfolio.',
        tasks: [
          'Crea los 5 archivos de animación en After Effects usando solo Shape Layers',
          'Expórtalos todos como Lottie .json usando Bodymovin',
          'Verifícalos en lottiefiles.com — asegúrate de que se ven correctamente y son loopeable donde corresponde',
          'Sube los archivos a una carpeta compartible en Drive y guarda el link',
          'Inserta al menos 2 de las animaciones en el proyecto de Framer o Webflow publicado',
        ],
        tip: 'Un kit de animaciones Lottie es algo que pocos diseñadores tienen y que los developers aprecian enormemente. Cuando trabajes con un equipo de desarrollo, entregar animaciones listas en formato Lottie en lugar de videos o GIFs marca la diferencia — los developers pueden integrarlas directamente sin rehacer el trabajo.',
        completed: false,
      },
      {
        id: 'up-m4',
  ...
  },
  {
    ...
    description:
      'Construye un design system reutilizable en Figma y crea un portfolio UI/UX que demuestre tu trabajo. El diferencial que convierte proyectos en oportunidades.',
    duration: '3–4 semanas',
    status: 'available',
    lessons: [
      {
      ...
      },
      {
        ...
        type: 'practice',
        content:
          '## El ejercicio más revelador para entender design systems\n\nAntes de construir el tuyo, necesitas ver cómo funciona uno en producción. Esta práctica te da ese contexto en 30 minutos.\n\n## El sistema a explorar: Material Design 3\n\nAbre m3.material.io y navega con estructura — no leas todo. El objetivo es entender cómo está organizado y qué decisiones tomaron.\n\n## Las preguntas a responder\n\n**Sobre la estructura**:\n- ¿Cómo están organizados los tokens? ¿Hay primitivos y semánticos separados?\n- ¿Cuál es la diferencia entre tokens de "source" y "key colors"?\n- ¿Cómo nombran los componentes? ¿Hay una convención clara?\n\n**Sobre los componentes**:\n- Abre el componente "Button" — ¿cuántas variantes tiene? ¿Cuántos estados?\n- Abre el componente "Card" — ¿cómo documenta cuándo usar cada variante?\n- ¿Qué información incluye la documentación además de la visual?\n\n**Para AlphaDev Studios**:\n- ¿Qué de Material Design 3 adaptarías a la identidad de AlphaDev?\n- ¿Qué descartarías? ¿Por qué?',
        tasks: [
          'Explora Material Design 3 (m3.material.io) durante 30 minutos con las preguntas como guía',
          'Responde las preguntas por escrito — no en la cabeza',
          'Descarga el kit de Material Design 3 de Figma Community y analiza cómo está construido internamente',
          'Lista los 5 componentes que más necesitaría el design system de AlphaDev Studios',
        ],
        tip: 'El valor de estudiar Material Design 3 no es copiarlo — es entender el nivel de profundidad que requiere un design system real. Cuando ves que un solo componente (Button) tiene 5 variantes × 5 estados = 25 combinaciones documentadas, entiendes por qué los design systems tardan meses en construirse bien.',
        completed: false,
      },
      {
        id: 'u4-l2',
        ...
        type: 'reading',
        content:
          '## Qué son los design tokens\n\nLos **design tokens** son la capa de abstracción entre los valores de diseño y el código. En lugar de usar `#9A7235` directamente en cada componente, usas el token `color/brand/gold`. Cuando el color de la marca cambia, actualizas el token una sola vez y todos los componentes se actualizan.\n\nEn código, los tokens se implementan como variables CSS, variables de Sass o como archivos JSON que comparten los equipos de diseño y desarrollo. En Figma, se implementan como **Variables**.\n\n## Tipos de tokens\n\n**Primitivos (valores base)**: los colores, tipografías y espaciados en su forma más básica.\n- `color/neutral/100` = `#FAFAF7`\n- `color/gold/base` = `#9A7235`\n- `spacing/4` = `16px`\n\n**Semánticos (significado funcional)**: tokens que usan los primitivos pero con un nombre de propósito.\n- `color/background/default` → usa `color/neutral/100`\n- `color/accent/primary` → usa `color/gold/base`\n- `spacing/section/padding` → usa `spacing/4`\n\n## Por qué importa la distinción\n\nSi un componente usa `color/gold/base` directamente y el gold cambia de tono, tienes que buscarlo en todo el archivo. Si usa `color/accent/primary`, actualizas el token semántico y todo el sistema se adapta.\n\n## En Figma: cómo crear Variables\n\nPanel derecho > Variables > Create variable. Crea una colección (ej: "Colors"), define los primitivos primero, luego los semánticos que referencian a los primitivos. Conéctalos a componentes mediante el panel de color de cada capa.',
        tasks: [
          'Crea una colección de Variables en Figma con los colores de AlphaDev Studios (todos los tokens del CLAUDE.md)',
          'Divide los tokens en dos grupos: Primitivos (el valor real) y Semánticos (el propósito)',
          'Conecta los variables a los componentes que creaste en el Módulo 2 — el botón primario debe usar los tokens, no valores hardcodeados',
          'Cambia el valor de un token primitivo y verifica que todos los componentes conectados se actualizan',
        ],
        tip: 'La nomenclatura de tokens es una decisión de largo plazo que no se puede cambiar fácilmente después. Antes de crear el primer token, define la convención completa: `categoria/subcategoria/nombre`. Un equipo que usa `btn-primary-bg` y otro que usa `color/button/primary/background` van a tener problemas para compartir tokens. La consistencia desde el día uno evita deuda técnica de diseño.',
        completed: false,
      },
      {
        id: 'u4-l2b',
        title: 'Mini-práctica: crea los primeros tokens de AlphaDev en Figma',
        type: 'practice',
        content:
          '## El primer paso real de un design system\n\nLos tokens de diseño son la base de toda consistencia visual. Esta práctica crea los tokens de color de AlphaDev Studios en Figma usando Variables.\n\n## Los tokens a crear\n\n**Colección "Colors — Primitives"**:\n- `gold/base` → #9A7235\n- `gold/light` → #C9A465\n- `gold/dark` → #7A5828\n- `neutral/bg` → #FAFAF7\n- `neutral/bg-alt` → #F2EEE7\n- `neutral/text` → #1A1512\n- `neutral/text-muted` → #6B5F52\n\n**Colección "Colors — Semantic"**:\n- `background/default` → alias de neutral/bg\n- `background/alternate` → alias de neutral/bg-alt\n- `text/primary` → alias de neutral/text\n- `text/secondary` → alias de neutral/text-muted\n- `accent/primary` → alias de gold/base\n- `accent/hover` → alias de gold/dark\n\n## Cómo crear Variables en Figma\n\nPanel derecho > Variables (icono de rombo) > Create new variable. Crea una colección por cada grupo. Para los semánticos, usa "Link to variable" al asignar el valor para que apunten a los primitivos.',
        tasks: [
          'Crea la colección "Colors — Primitives" con los 7 tokens de color de AlphaDev',
          'Crea la colección "Colors — Semantic" con los 6 tokens semánticos apuntando a los primitivos',
          'Aplica los tokens semánticos al componente Button que construiste en la lección anterior',
          'Cambia el valor de gold/base por otro color — verifica que el botón primario se actualiza automáticamente',
        ],
        tip: 'La prueba de fuego de un token semántico: si cambias el valor del primitivo al que apunta, ¿todos los componentes que usan el semántico se actualizan solos? Si sí, el sistema está bien construido. Si tienes que buscar instancias manualmente, hay un problema de arquitectura.',
        completed: false,
      },
      {
        id: 'u4-l3',
        ...
        type: 'reading',
        content:
          '## El error más común del portfolio de diseño\n\nMostrar solo el resultado final. Un portfolio de UI/UX que muestra únicamente pantallas hermosas no demuestra nada sobre tu proceso de pensamiento — y el proceso es lo que diferencia a un diseñador de alguien que sabe usar Figma.\n\nLo que los reclutadores y clientes realmente quieren ver: **¿puedes resolver un problema de diseño complejo de forma metodológica?**\n\n## La estructura ideal de un case study\n\n**1. Contexto y problema**: ¿qué producto es?, ¿para quién?, ¿qué problema de UX existía? Esta sección debe conectar emocionalmente — el lector tiene que sentir que el problema era real.\n\n**2. Research y hallazgos**: ¿qué aprendiste antes de diseñar? Entrevistas, encuestas, análisis de competidores, datos de analytics. Aunque sea básico, muestra que tuviste un proceso.\n\n**3. Exploración y wireframes**: los primeros bocetos, las ideas descartadas, los prototipos de baja fidelidad. Esto muestra pensamiento iterativo — la marca de un buen diseñador.\n\n**4. Solución final**: las pantallas definitivas con explicación de las decisiones de diseño más importantes. ¿Por qué ese layout? ¿Por qué ese color? ¿Por qué ese flujo?\n\n**5. Resultado y aprendizaje**: métricas si las hay, feedback de usuarios, qué cambiarías si lo hicieras de nuevo.\n\n## Plataformas para el portfolio\n\n- **Dribbble**: para shots individuales, visibilidad en la comunidad de diseño\n- **Behance**: para case studies largos y proceso detallado\n- **Framer o Webflow**: para un portfolio personalizado con control total (lo que tienes que hacer después de este módulo)',
        tasks: [
          'Elige un proyecto que hayas hecho (del módulo 2 o cualquiera anterior) y planifica la estructura del case study',
          'Escribe el borrador de la sección "Contexto y problema" — al menos 3 párrafos explicando por qué el problema importaba',
          'Arma un PDF o Notion doc con las 5 secciones del case study, aunque algunas estén en borrador',
          'Sube una versión a Behance como draft — no necesita estar perfecto para publicarse',
        ],
        tip: 'La mejor táctica para tener case studies cuando eres junior es hacer proyectos no solicitados (unsolicited redesigns): eliges una app con mala UX, la rediseñas, documentas el proceso y lo publicas. No importa que nadie te lo encargó — lo que importa es que muestra cómo piensas. Muchos diseñadores consiguieron su primer trabajo con un redesign de una app famosa.',
        completed: false,
      },
      {
        id: 'u4-l5',
        ...
        type: 'practice',
        content:
          '## El primer ítem del portfolio\n\nEsta práctica produce el resultado más importante del módulo: el primer case study documentado de tu portfolio. Un diseñador sin portfolio público no existe para los clientes. Este es el paso que cambia eso.\n\n## El proyecto a documentar\n\nUsa el proyecto de 5 pantallas del Módulo 2 de este track — o cualquier proyecto que hayas hecho con más proceso documentado. Si no tienes ninguno todavía, haz un redesign de una pantalla de una app conocida (login, onboarding, o checkout) y documenta cada decisión.\n\n## La estructura a seguir\n\n**Portada**: nombre del proyecto, plataforma (iOS/Web/Android), tu rol, el año.\n\n**El problema**: 2–3 párrafos. ¿Qué no funcionaba y para quién? ¿Por qué era importante resolverlo?\n\n**El proceso**: capturas de wireframes, user flows, exploración de opciones. No ocultes las iteraciones — los borradores son la prueba de que pensaste.\n\n**La solución**: las pantallas finales con anotaciones que explican las decisiones de diseño. Cada pantalla debe tener una razón — explica por qué, no solo qué.\n\n**El resultado**: feedback de usuarios si lo tienes. Si no, describe qué mejorarías con más tiempo.\n\n## La publicación\n\nPublica en Behance o en un Notion doc compartible. El objetivo es que tenga una URL pública que puedas compartir en LinkedIn, en tu email de presentación, y en la bio de Instagram o Dribbble.',
        tasks: [
          'Elige el proyecto a documentar y completa la estructura de las 5 secciones del case study',
          'Escribe la sección de "El problema" — mínimo 2 párrafos con contexto real',
          'Arma la galería de imágenes: screenshots del proceso (FigJam, wireframes) + pantallas finales',
          'Publica el case study en Behance o Notion y obtén la URL pública',
          'Comparte el link en LinkedIn con una descripción breve del proyecto — este es el primer post de tu portfolio público',
        ],
  ...
  },
  {
    ...
    description:
      'Las herramientas que separan el top 1% de diseñadores del resto. No necesitas dominar todas — elige una y explórala a fondo. Rive para iconos interactivos, Spline para 3D en web, Unicorn Studio para efectos WebGL.',
    duration: '2–3 semanas',
    status: 'available',
    lessons: [
      {
        ...
        tasks: [
          'Crea una cuenta gratuita en rive.app y explora la interfaz durante 30 minutos',
          'Completa el primer tutorial oficial "Rive 101" en rive.app/learn-rive',
          'Explora la galería de la comunidad en rive.app/community — descarga 2 archivos y analiza cómo están construidas las state machines',
          'Crea un ícono simple con 2 estados (idle y hover) usando una state machine básica',
        ],
      ...
      },
      {
        ...
        type: 'practice',
        content:
          '## El objetivo\n\nUna animación con 2 estados (Idle → Hover) para un ícono simple. No tiene que ser compleja — tiene que demostrar que entendiste la lógica de las state machines.\n\n## El ícono a animar (elige uno)\n\n- **Opción A**: Estrella que pulsa al hacer hover (scale 1 → 1.2 con bounce)\n- **Opción B**: Corazón que se llena al hacer click (empty → filled)\n- **Opción C**: Bookmark que se activa (outline → filled con cambio de color)\n\n## El proceso en Rive\n\n1. Crea una cuenta en rive.app y abre un nuevo archivo\n2. Dibuja el ícono con las herramientas vectoriales de Rive (o importa un SVG desde Figma)\n3. En la pestaña Animate, crea la animación del estado Idle (si hay movimiento en reposo)\n4. Crea la animación del estado Hover (el cambio al interactuar)\n5. En la pestaña **State Machine**, conecta los estados:\n   - Idle → Hover: trigger "Mouse Enter"\n   - Hover → Idle: trigger "Mouse Leave"\n6. Previsualiza en modo Preview — mueve el mouse sobre el ícono\n\n## El resultado esperado\n\nEl ícono responde al hover con una animación suave y vuelve al idle cuando el mouse sale.',
        tasks: [
          'Crea el archivo en Rive y dibuja o importa el ícono elegido',
          'Crea las animaciones de los estados Idle y Hover por separado',
          'Configura la State Machine con los triggers Mouse Enter y Mouse Leave',
          'Previsualiza la interacción y ajusta el timing si se siente abrupto',
          'Exporta el archivo .riv y guárdalo como primera pieza de tu kit de animaciones',
        ],
        tip: 'El primer ícono en Rive siempre lleva más tiempo de lo esperado — hay que aprender la interfaz mientras se diseña. No te preocupes por el tiempo del primero. El segundo va a tardar la mitad. La curva de Rive es empinada pero corta.',
        completed: false,
      },
      {
        id: 'u8-l2',
        ...
        type: 'reading',
        content:
          '## Qué es Spline y qué lo hace único\n\n**Spline** es un editor 3D que genera escenas y animaciones que se embeben directamente en sitios web — sin Three.js, sin WebGL manual, sin conocimiento de 3D avanzado. Es el puente entre el diseño visual y el 3D en web que antes solo existía para developers especializados.\n\n## Casos de uso ideales\n\n- Hero con objeto 3D interactivo (el usuario puede rotar con el mouse)\n- Íconos 3D animados que acompañan features de un producto\n- Fondos con profundidad y movimiento de parallax 3D\n- Visualizaciones de producto (mockups 3D de apps o dispositivos)\n\n## El flujo de trabajo\n\n1. Diseñas la escena en **spline.design** — interfaz visual similar a Figma pero en 3D\n2. Configuras la animación (auto-rotate, scroll-driven, mouse-tracking)\n3. Exportas como código embebible (snippet HTML), React component, o iframe\n4. Lo insertas en Framer (componente de código), Webflow (embed), o Next.js\n\n## Las limitaciones a conocer\n\n**Performance**: Spline agrega peso de carga significativo. En una landing page de alto impacto puede valer el tradeoff. En un sitio que prioriza Core Web Vitals y velocidad extrema, puede no ser la mejor opción.\n\n**Versión gratuita**: muestra el logo de Spline en el embed. El plan pago lo elimina (~$14 USD/mes).\n\n**Compatibilidad**: funciona en todos los browsers modernos pero no en versiones antiguas de Safari o IE.',
        tasks: [
          'Crea una cuenta en spline.design y explora la interfaz durante 30 minutos',
          'Sigue el tutorial oficial de introducción de Spline (30–60 minutos)',
          'Crea una escena simple: una esfera o cubo 3D con materiales y una animación de auto-rotate',
          'Exporta la escena como HTML embebible y copia el código',
          'Pega el código en un proyecto de Framer o en un archivo HTML simple y verifica que funciona',
        ],
        tip: 'Antes de comprometerte con Spline en un proyecto real, mide el impacto en performance. Abre Chrome DevTools > Network tab y carga la página con el embed de Spline. Si el script de Spline pesa más de 500KB adicionales y el cliente o proyecto tiene requisitos de velocidad, considera alternativas como una imagen estática con un video de fondo que simule el 3D.',
        completed: false,
      },
      {
        id: 'u8-l2b',
        title: 'Mini-práctica: diseña un objeto 3D en Spline',
        type: 'practice',
        content:
          '## El resultado esperado\n\nUna escena 3D con al menos 1 objeto, materiales aplicados y animación básica (auto-rotate o mouse-follow), lista para embeber.\n\n## El objeto a crear (elige por nivel de comodidad)\n\n- **Opción A — Esfera**: lo más simple. Material glossy o gradient + auto-rotate.\n- **Opción B — Cubo redondeado**: corner radius grande. Dos materiales en caras distintas.\n- **Opción C — Logo 3D**: extrusión del logo o iniciales de AlphaDev en 3D.\n\n## El proceso en Spline\n\n1. Crea cuenta en spline.design y abre un proyecto vacío (Empty Scene)\n2. Inserta la forma base desde el menú Add\n3. Aplica un material desde el panel de Material (metal, glass, gradient)\n4. Ajusta la iluminación: prueba directional light y ambient light\n5. En el panel de Animaciones, configura "Spin" en el eje Y para auto-rotate\n6. Desde Share > Export, copia el snippet HTML\n\n## La verificación\n\nPega el snippet en un archivo HTML simple y abrilo en Chrome. El objeto debe verse y rotar. Revisa el peso del script de Spline en DevTools Network — ¿es aceptable para el proyecto?',
        tasks: [
          'Crea la escena con el objeto y los materiales seleccionados',
          'Configura la animación de auto-rotate o mouse-tracking en el panel de Animaciones',
          'Ajusta la iluminación para que el objeto se vea tridimensional, no plano',
          'Exporta el snippet HTML y verifica que funciona en un archivo HTML local en Chrome',
          'Anota el peso del script de Spline — ¿es viable para un proyecto real con requisitos de velocidad?',
        ],
        tip: 'La iluminación hace que un objeto 3D se vea premium o genérico. Un cubo gris sin luz parece un placeholder. El mismo cubo con directional light desde arriba-derecha y ambient light suave parece un render de Apple. Experimenta con las luces antes de finalizar los materiales.',
        completed: false,
      },
      {
        id: 'u8-l3',
        ...
        type: 'reading',
        content:
          '## Qué es Unicorn Studio\n\n**Unicorn Studio** genera efectos visuales WebGL — shaders, gradientes fluidos, noise effects, partículas — que se activan y deforman con el scroll o el movimiento del mouse. Es la herramienta para crear backgrounds que "viven" sin contratar a un specialist en WebGL.\n\n## Por qué es relevante para diseñadores UI\n\nHasta hace poco, un background de gradiente fluido animado como el de Linear.app o Stripe era exclusividad de developers que sabían GLSL (el lenguaje de shaders de WebGL). Unicorn Studio democratiza eso: en 20–30 minutos puedes tener un efecto equivalente sin escribir una línea de código.\n\n## Casos de uso\n\n- **Hero backgrounds** con gradiente fluido animado\n- **Secciones "wow"** en landing pages premium — el momento donde el visitante se detiene\n- **Efectos de partículas** sutiles como fondo de una sección de features\n- **Transiciones de scroll** donde el fondo evoluciona mientras el usuario hace scroll\n\n## La integración\n\nIgual que Spline: un snippet de HTML o iframe que pegas en Framer, Webflow, o cualquier página. El efecto carga desde los servidores de Unicorn Studio.\n\n## El tradeoff\n\nLos efectos WebGL tienen un costo de performance — especialmente en mobile con GPU limitada. Unicorn Studio tiene controles de fallback para mobile (mostrar una imagen estática cuando el efecto sería demasiado pesado). Usálo siempre con esta consideración.',
        tasks: [
          'Explora la galería de templates en unicornstudio.io — identifica 3 efectos que te gustarían usar en un proyecto real',
          'Crea una cuenta gratuita y explora el editor de Unicorn Studio durante 30 minutos',
          'Configura un efecto de gradiente fluido o noise para un hero — ajusta colores para que coincidan con la paleta de AlphaDev',
          'Exporta el snippet y pégalo en un documento HTML simple — verifica que el efecto se ve correctamente',
        ],
      ...
      {
        id: 'u8-l3b',
        title: 'Mini-práctica: crea un efecto WebGL para el hero de AlphaDev',
        type: 'practice',
        content:
          '## El objetivo\n\nUn background animado con los colores de AlphaDev (#FAFAF7 crema + #9A7235 dorado) listo para embeber en el hero del sitio. El efecto debe ser sutil — refuerza la atmósfera sin competir con el headline.\n\n## El proceso en Unicorn Studio\n\n1. Regístrate en unicornstudio.io y abre el editor\n2. Explora la galería de templates — busca algo basado en gradientes o noise (no partículas, más pesadas)\n3. Abre un template como base y modifícalo\n4. Ajusta los colores a la paleta de AlphaDev:\n   - Color 1: #FAFAF7 (crema base)\n   - Color 2: #F2EEE7 (crema alternativa)\n   - Color 3: #9A7235 (dorado) — con opacidad muy baja (15–25%) para que sea sutil\n5. Ajusta la velocidad: para un hero elegante, usa speed 0.2–0.4 (no hiperactivo)\n6. Exporta el snippet y embedilo en el proyecto de Framer del módulo anterior\n\n## La regla de oro\n\nSi el efecto llama más la atención que el headline, está demasiado agresivo. El background debe decirle "este sitio es especial" antes de que lean una palabra — sin pedirles que lo miren específicamente.',
        tasks: [
          'Explora al menos 3 templates de Unicorn Studio antes de elegir uno',
          'Ajusta los colores a la paleta de AlphaDev con el dorado en opacidad muy baja',
          'Configura la velocidad del efecto para que sea lento y elegante',
          'Exporta el snippet y embedilo en el proyecto de Framer publicado',
          'Verifica en mobile que el efecto tiene un fallback o se ve aceptable en GPU limitada',
        ],
      ...
      {
        id: 'u8-l4',
        title: 'La estrategia correcta: elige una y domínala',
        type: 'reading',
        content:
          '## El error más común con herramientas avanzadas\n\nColeccionarlas sin dominar ninguna. Muchos diseñadores ven demos de Rive, Spline y Unicorn Studio, los instalan todos, hacen el tutorial de introducción de cada uno y luego no usan ninguno en un proyecto real. La familiaridad superficial con muchas herramientas no construye valor.\n\n## La recomendación directa\n\nElige **UNA** de estas herramientas y explora todo lo que puede hacer. Úsala en al menos 3 proyectos reales antes de considerar aprender otra.\n\n## El árbol de decisión\n\n**Si ya dominas After Effects + Lottie** → Rive es el siguiente paso natural. Ambas trabajan con animaciones vectoriales para web/mobile. Rive agrega la interactividad con state machines que Lottie no tiene.\n\n**Si tu foco es webs y landing pages premium** → Spline o Unicorn Studio. Si quieres objetos 3D interactivos → Spline. Si quieres fondos que "viven" → Unicorn Studio.\n\n**Si recién empiezas** → Rive primero. Es la herramienta con más aplicaciones universales (web, iOS, Android) y la que más demanda tiene en el mercado actualmente.\n\n## Por qué cualquiera de estas te separa del 99%\n\nLa mayoría de los diseñadores UI no sabe que estas herramientas existen. Dominar una sola ya te pone en un percentil muy pequeño del mercado. El criterio para mostrarla en portfolio: un proyecto real publicado con la herramienta integrada — no un demo de práctica.',
        tasks: [
          'Decide cuál de las tres herramientas vas a priorizar y escribe en 3 líneas por qué esa específicamente',
          'Comprométete con un proyecto real donde la usarás — no un ejercicio de práctica, sino algo que vas a publicar',
          'Busca en LinkedIn o Twitter a 3 diseñadores que usen la herramienta que elegiste — seguílos y analiza su trabajo',
          'Define cuántas horas por semana vas a dedicar a esta herramienta durante el próximo mes',
        ],
        tip: 'La forma de dominar una herramienta avanzada no es hacer sus tutoriales — es usarla para resolver un problema real con deadline. El deadline y el cliente (aunque sea tú mismo) fuerzan el aprendizaje de las partes que los tutoriales no cubren. "Tengo que publicar esto el viernes" enseña más que 10 tutoriales sin presión.',
        completed: false,
      },
      {
        id: 'u8-l5',
        ...
        type: 'practice',
        content:
          '## El objetivo: elevar el nivel del portfolio con una herramienta del top 1%\n\nEsta práctica toma el sitio que publicaste en el módulo de Webflow/Framer y lo eleva un nivel significativo: agrega una animación avanzada con la herramienta que elegiste. Un sitio con un Rive interactivo, un objeto Spline o un background de Unicorn Studio en producción ya está en otro nivel de portfolio.\n\n## Las opciones según tu herramienta elegida\n\n**Opción A — Rive**: crea un ícono animado con al menos 2 estados (idle + hover). El caso ideal: el ícono del CTA principal de la landing page (una flecha que se mueve, un botón de play que pulsa, un menú hamburguesa que se transforma). Integración en Framer: componente de código con el runtime de Rive.\n\n**Opción B — Spline**: crea un objeto 3D simple con auto-rotate — una esfera abstracta, un cubo con materiales, o el logo de tu proyecto en 3D. Colocálo en el hero como elemento visual complementario (no reemplazo del headline). Integración en Framer/Webflow: snippet de código en un embed.\n\n**Opción C — Unicorn Studio**: crea un background animado para el hero — gradiente fluido o noise effect con los colores de la paleta del sitio. El efecto va detrás del headline, no encima. Integración en Framer/Webflow: snippet de código en un embed.\n\n## El entregable\n\nEl sitio republicado con la animación avanzada integrada + un screenshot o grabación del resultado para el portfolio.',
        tasks: [
          'Crea el asset en la herramienta elegida (Rive, Spline o Unicorn Studio)',
          'Integrálo en el sitio publicado de Framer o Webflow del módulo anterior',
          'Verifica que funciona correctamente en mobile — haz ajustes si es necesario',
          'Republica el sitio con la URL accesible',
          'Graba un video de 10–15 segundos mostrando la animación integrada en el sitio y publícalo en redes',
        ],
        tip: 'Cuando presentes este proyecto en tu portfolio, incluye siempre una nota de qué herramienta usaste y por qué la elegiste para ese caso específico. La decisión de herramienta es parte del proceso de diseño — mostrarla demuestra pensamiento estratégico, no solo habilidad técnica.',
        completed: false,
      },
      {
        id: 'up-d3',
