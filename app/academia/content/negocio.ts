...
Este capstone produce el segundo escenario.`,
  ...
  },
  {
    ...
    lessons: [
      {
        id: 'ventas-cap-0',
        title: 'Antes de construir: valida el ICP con 3 conversaciones reales',
        type: 'practice',
        tasks: [
          'Escribe tu primera versión del ICP: industria, tamaño, etapa, problema principal, presupuesto aproximado',
          'Habla con 3 personas que encajen (o casi encajen) en ese perfil — no para venderles, para preguntarles si el problema que asumiste que tienen es real y cómo lo describen con sus propias palabras',
          'Ajusta el ICP con lo que aprendiste: es normal que cambie después de estas 3 conversaciones — si no cambió nada, probablemente no preguntaste lo suficiente',
        ],
        tip: 'Un funnel completo construido sobre un ICP que nunca se validó con una conversación real es la forma más común de perder dos semanas en un sistema que genera leads que no califican. Las 3 conversaciones son la parte más barata de arreglar un mal diagnóstico — antes de construir, no después.',
        completed: false,
      },
      {
      ...
      },
      {
        ...
        type: 'practice',
        tasks: [
          '¿La landing page está publicada en una URL real, o sigue siendo un mockup en Figma?',
          '¿El CRM tiene prospectos REALES cargados, no datos de ejemplo?',
          '¿El guión de discovery call tiene respuestas escritas a las 3 objeciones, no solo la lista de preguntas?',
          '¿Calendly filtra prospectos con preguntas de calificación antes de agendar, o cualquiera puede reservar sin filtro?',
          '¿Hiciste de verdad al menos una discovery call (real o roleplay) y documentaste qué funcionó y qué no?',
        ],
        tip: 'Un CRM con datos de ejemplo en vez de prospectos reales es la señal más clara de que el proyecto quedó en plan y nunca se lanzó de verdad. El objetivo de este capstone es un sistema funcionando, no un sistema documentado.',
        completed: false,
      },
    ],
    resources: [],
