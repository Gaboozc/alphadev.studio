...
export type Track = 'marketing' | 'uiux' | 'web' | 'ia' | 'branding' | 'copy' | 'seo' | 'geo' | 'data' | 'ads' | 'email' | 'video' | 'community' | 'prodai' | 'ventas' | 'fundamentos' | 'backend' | 'iaeng-modelos' | 'iaeng-agentes' | 'iaeng-produccion'
