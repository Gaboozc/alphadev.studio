...
import { MODULES_IAENG_MODELOS, MODULES_IAENG_AGENTES, MODULES_IAENG_PRODUCCION } from './content/iaeng'
...
export const MODULES: Module[] = [
  ...
  ...MODULES_DISENO,
  ...MODULES_IA,
  ...MODULES_IAENG_MODELOS,
  ...MODULES_IAENG_AGENTES,
  ...MODULES_IAENG_PRODUCCION,
  ...MODULES_MARKETING,
  ...MODULES_CONTENIDO,
  ...MODULES_NEGOCIO,
]
