...
export const RAMAS: RamaMeta[] = [
  ...
  },
  {
    ...
    familia: 'construir',
    icon: 'cpu',
    description: 'Construir los sistemas: modelos y RAG, agentes que actúan, y todo lo que hace falta para que eso aguante en producción. Requiere Programación.',
    tracks: ['iaeng-modelos', 'iaeng-agentes', 'iaeng-produccion'],
  },
  {
    id: 'marketing',
    slug: 'marketing',
